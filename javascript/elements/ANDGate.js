...
class ANDGate {
    ...
    partial_and(terminal, ui, ui_prime) {
        let sum = 0;
        let N = 2;
        let size = ui.length;
        for (var i = 0; i < ui.length; i++) {
    ...
    update() {
        if (global.flags.flag_simulating && simulation_manager.solutions_ready) {
            if (this.elm.consistent()) {
                ...
                this.elm.properties['V_partial1'] = global.utils.limit(this.partial_and(0, [this.elm.properties['V_1'], this.elm.properties['V_2']], [this.elm.properties['V_1_prime'], this.elm.properties['V_2_prime']]), 0.0, 1.0);
                this.elm.properties['V_partial2'] = global.utils.limit(this.partial_and(1, [this.elm.properties['V_1'], this.elm.properties['V_2']], [this.elm.properties['V_1_prime'], this.elm.properties['V_2_prime']]), 0.0, 1.0);
