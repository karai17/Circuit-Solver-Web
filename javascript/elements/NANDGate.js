...
class NANDGate {
    ...
    partial_nand(terminal, ui, ui_prime) {
        let sum = 0;
        let N = 2;
        let size = ui.length;
        for (var i = 0; i < ui.length; i++) {
    ...
    update() {
        if (global.flags.flag_simulating && simulation_manager.solutions_ready) {
            if (this.elm.consistent()) {
                ...
                this.elm.properties['V_partial1'] = global.utils.limit(this.partial_nand(0, [this.elm.properties['V_1'], this.elm.properties['V_2']], [this.elm.properties['V_1_prime'], this.elm.properties['V_2_prime']]), 0.0, 1.0);
                this.elm.properties['V_partial2'] = global.utils.limit(this.partial_nand(1, [this.elm.properties['V_1'], this.elm.properties['V_2']], [this.elm.properties['V_1_prime'], this.elm.properties['V_2_prime']]), 0.0, 1.0);
    ...
    build_element() {
        if ((this.build_element_flag || global.flags.flag_build_element) &&
            ...
            let cache_6 = 0.9 * this.x_space;
            let cache_7 = 0.9 * this.y_space;
            let cache_8 = 0.6 * this.x_space;
            let cache_9 = 0.6 * this.y_space;
            let cache_10 = 0.3 * this.x_space;
            let cache_11 = 0.3 * this.y_space;
            let cache_12 = this.x_space;
            let cache_13 = this.y_space;
