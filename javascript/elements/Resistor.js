...
class Resistor {
    constructor(type, id, n1, n2) {
        ...
        this.elm = new Element2(id, type, global.utils.copy(global.PROPERTY.PROPERTY_RESISTOR));
    ...
    build_element() {
        if ((this.build_element_flag || global.flags.flag_build_element) &&
            ...
            this.res_0.x = this.c_x - cache_0 * global.utils.cosine(this.theta) + (cache_6 >> 1) * global.utils.cosine(this.theta_m90);
            this.res_0.y = this.c_y - cache_1 * global.utils.sine(this.theta) + (cache_7 >> 1) * global.utils.sine(this.theta_m90);
            this.res_2.x = this.c_x + (cache_6 >> 1) * global.utils.cosine(this.theta_m90);
            this.res_2.y = this.c_y + (cache_7 >> 1) * global.utils.sine(this.theta_m90);
            this.res_1.x = this.c_x - cache_2 * global.utils.cosine(this.theta) + (cache_6 >> 1) * global.utils.cosine(Math.PI + this.theta_m90);
            this.res_1.y = this.c_y - cache_3 * global.utils.sine(this.theta) + (cache_7 >> 1) * global.utils.sine(Math.PI + this.theta_m90);
            this.res_3.x = this.c_x + cache_2 * global.utils.cosine(this.theta) + (cache_6 >> 1) * global.utils.cosine(Math.PI + this.theta_m90);
            this.res_3.y = this.c_y + cache_3 * global.utils.sine(this.theta) + (cache_7 >> 1) * global.utils.sine(Math.PI + this.theta_m90);
            this.res_4.x = this.c_x + cache_0 * global.utils.cosine(this.theta) + (cache_6 >> 1) * global.utils.cosine(this.theta_m90);
            this.res_4.y = this.c_y + cache_1 * global.utils.sine(this.theta) + (cache_7 >> 1) * global.utils.sine(this.theta_m90);
            this.res_5.x = this.c_x + cache_6 * global.utils.cosine(this.theta) + cache_4 * global.utils.cosine(this.theta_m90);
            this.res_5.y = this.c_y + cache_7 * global.utils.sine(this.theta) + cache_5 * global.utils.sine(this.theta_m90);
            this.res_6.x = this.c_x - cache_6 * global.utils.cosine(this.theta) + cache_4 * global.utils.cosine(this.theta_m90);
            this.res_6.y = this.c_y - cache_7 * global.utils.sine(this.theta) + cache_5 * global.utils.sine(this.theta_m90);
            this.res_7.x = this.c_x + cache_6 * global.utils.cosine(this.theta) + cache_4 * global.utils.cosine(Math.PI + this.theta_m90);
            this.res_7.y = this.c_y + cache_7 * global.utils.sine(this.theta) + cache_5 * global.utils.sine(Math.PI + this.theta_m90);
            this.res_8.x = this.c_x - cache_6 * global.utils.cosine(this.theta) + cache_4 * global.utils.cosine(Math.PI + this.theta_m90);
            this.res_8.y = this.c_y - cache_7 * global.utils.sine(this.theta) + cache_5 * global.utils.sine(Math.PI + this.theta_m90);
            this.connect1_x = this.c_x - cache_6 * global.utils.cosine(this.theta);
            this.connect1_y = this.c_y - cache_7 * global.utils.sine(this.theta);
            this.connect2_x = this.c_x + cache_6 * global.utils.cosine(this.theta);
            this.connect2_y = this.c_y + cache_7 * global.utils.sine(this.theta);
