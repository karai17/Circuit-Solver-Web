...
class DCCurrent {
    constructor(type, id, n1, n2) {
        ...
        this.elm = new Element2(id, type, global.utils.copy(global.PROPERTY.PROPERTY_DCCURRENT));
    ...
    build_element() {
        if ((this.build_element_flag || global.flags.flag_build_element) &&
            ...
            this.dcc_0.x = this.c_x - cache_0 * global.utils.cosine(this.theta);
            this.dcc_0.y = this.c_y - cache_1 * global.utils.sine(this.theta);
            this.dcc_1.x = this.c_x + cache_0 * global.utils.cosine(this.theta);
            this.dcc_1.y = this.c_y + cache_1 * global.utils.sine(this.theta);
            this.dcc_2.x = this.c_x - cache_2 * global.utils.cosine(this.theta) + (cache_5 >> 1) * global.utils.cosine(this.theta_m90);
            this.dcc_2.y = this.c_y - cache_3 * global.utils.sine(this.theta) + (cache_5 >> 1) * global.utils.sine(this.theta_m90);
            this.dcc_3.x = this.c_x - cache_2 * global.utils.cosine(this.theta) + (cache_5 >> 1) * global.utils.cosine(Math.PI + this.theta_m90);
            this.dcc_3.y = this.c_y - cache_3 * global.utils.sine(this.theta) + (cache_5 >> 1) * global.utils.sine(Math.PI + this.theta_m90);
    ...
    draw_component(canvas) {
        ...
        if (global.flags.flag_picture_request ||
            ...
            this.circle_buffer = [];
            this.line_buffer = [];
            this.line_buffer[this.indexer++] = Array(this.dcc_0.x, this.dcc_0.y, this.dcc_1.x, this.dcc_1.y);
            this.line_buffer[this.indexer++] = Array(this.dcc_2.x, this.dcc_2.y, this.dcc_0.x, this.dcc_0.y);
            this.line_buffer[this.indexer++] = Array(this.dcc_0.x, this.dcc_0.y, this.dcc_3.x, this.dcc_3.y);
