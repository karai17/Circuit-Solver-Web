...
class DCSource {
    constructor(type, id, n1, n2) {
        ...
        this.elm = new Element2(id, type, global.utils.copy(global.PROPERTY.PROPERTY_DCSOURCE));
    ...
    build_element() {
        if ((this.build_element_flag || global.flags.flag_build_element) &&
            ...
            let cache_2 = 0.57142 * this.x_space;
            let cache_3 = 0.57142 * this.y_space;
            let cache_4 = 0.25 * this.x_space;
            let cache_5 = 0.25 * this.y_space;
            let cache_6 = 0.0625 * this.x_space;
            let cache_7 = 0.0625 * this.y_space;
            let cache_8 = this.x_space;
            let cache_9 = this.y_space;
            this.dc_0.x = this.c_x + cache_0 * global.utils.cosine(this.theta) + (cache_8 >> 2) * global.utils.cosine(this.theta_m90);
            this.dc_0.y = this.c_y + cache_1 * global.utils.sine(this.theta) + (cache_8 >> 2) * global.utils.sine(this.theta_m90);
            this.dc_1.x = this.c_x + cache_0 * global.utils.cosine(this.theta) + (cache_8 >> 2) * global.utils.cosine(Math.PI + this.theta_m90);
            this.dc_1.y = this.c_y + cache_1 * global.utils.sine(this.theta) + (cache_8 >> 2) * global.utils.sine(Math.PI + this.theta_m90);
            this.dc_2.x = this.c_x - cache_2 * global.utils.cosine(this.theta);
            this.dc_2.y = this.c_y - cache_3 * global.utils.sine(this.theta);
            this.dc_3.x = this.c_x - cache_4 * global.utils.cosine(this.theta) + (cache_8 >> 2) * global.utils.cosine(this.theta_m90);
            this.dc_3.y = this.c_y - cache_5 * global.utils.sine(this.theta) + (cache_8 >> 2) * global.utils.sine(this.theta_m90);
            this.dc_4.x = this.c_x - cache_4 * global.utils.cosine(this.theta) + (cache_8 >> 2) * global.utils.cosine(Math.PI + this.theta_m90);
            this.dc_4.y = this.c_y - cache_5 * global.utils.sine(this.theta) + (cache_8 >> 2) * global.utils.sine(Math.PI + this.theta_m90);
            this.dc_5.x = this.c_x + cache_6 * global.utils.cosine(this.theta);
            this.dc_5.y = this.c_y + cache_7 * global.utils.sine(this.theta);
