...
class ACCurrent {
    constructor(type, id, n1, n2) {
        ...
        this.elm = new Element2(id, type, global.utils.copy(global.PROPERTY.PROPERTY_ACCURRENT));
    ...
    build_element() {
        if ((this.build_element_flag || global.flags.flag_build_element) &&
            ...
            this.acc_0.x = this.c_x - cache_0 * global.utils.cosine(this.theta);
            this.acc_0.y = this.c_y - cache_1 * global.utils.sine(this.theta);
            this.acc_1.x = this.c_x + cache_0 * global.utils.cosine(this.theta);
            this.acc_1.y = this.c_y + cache_1 * global.utils.sine(this.theta);
            this.acc_2.x = this.c_x - cache_2 * global.utils.cosine(this.theta) + (cache_4 >> 1) * global.utils.cosine(this.theta_m90);
            this.acc_2.y = this.c_y - cache_3 * global.utils.sine(this.theta) + (cache_5 >> 1) * global.utils.sine(this.theta_m90);
            this.acc_3.x = this.c_x - cache_2 * global.utils.cosine(this.theta) + (cache_4 >> 1) * global.utils.cosine(Math.PI + this.theta_m90);
            this.acc_3.y = this.c_y - cache_3 * global.utils.sine(this.theta) + (cache_5 >> 1) * global.utils.sine(Math.PI + this.theta_m90);
            this.sine_wave_p1.x = this.c_x + (cache_4 >> 2) * global.utils.cosine(this.theta) - (cache_4 >> 1) * global.utils.cosine(Math.PI + this.theta_m90);
            this.sine_wave_p1.y = this.c_y + (cache_5 >> 2) * global.utils.sine(this.theta) - (cache_5 >> 1) * global.utils.sine(Math.PI + this.theta_m90);
            this.sine_wave_p2.x = this.c_x + (cache_4 >> 2) * global.utils.cosine(this.theta) + (cache_4 >> 1) * global.utils.cosine(Math.PI + this.theta_m90);
            this.sine_wave_p2.y = this.c_y + (cache_5 >> 2) * global.utils.sine(this.theta) + (cache_5 >> 1) * global.utils.sine(Math.PI + this.theta_m90);
    ...
    recolor() {
        if (global.variables.selected) {
            if (global.variables.selected_id === this.elm.id && global.variables.selected_type === this.elm.type) {
                ...
                this.point_paint.set_color(global.COLORS.ELEMENT_COLOR);
                this.text_paint.set_color(global.COLORS.ELEMENT_COLOR);
                this.sine_wave.set_color(global.COLORS.ELEMENT_COLOR);
            }
        }
        else {
            if (this.multi_selected) {
                ...
                this.sine_wave.set_color(global.COLORS.MULTI_SELECTED_COLOR);
            }
            else {
                this.line_paint.set_color(global.COLORS.ELEMENT_COLOR);
                this.point_paint.set_color(global.COLORS.ELEMENT_COLOR);
    ...
    draw_component(canvas) {
        ...
        if (global.flags.flag_picture_request ||
            ...
            this.circle_buffer = [];
            this.line_buffer = [];
            this.line_buffer[this.indexer++] = Array(this.acc_0.x, this.acc_0.y, this.acc_1.x, this.acc_1.y);
            this.line_buffer[this.indexer++] = Array(this.acc_2.x, this.acc_2.y, this.acc_0.x, this.acc_0.y);
            this.line_buffer[this.indexer++] = Array(this.acc_0.x, this.acc_0.y, this.acc_3.x, this.acc_3.y);
            ...
            if (global.variables.workspace_zoom_scale > 1.085 || (!MOBILE_MODE && global.variables.workspace_zoom_scale >= 0.99)) {
                ...
                if ((this.angle > 170 && this.angle < 190) || (this.angle > -10 && this.angle < 10)) {
                    canvas.draw_text(global.TEMPLATES.ELEMENT_VAL_TEMPLATE.replace('{VAL}', global.utils.exponentiate_quickly(this.elm.properties['Current'])).replace('{UNIT}', this.elm.properties['units']), this.c_x, this.bounds.top + this.bounds.get_height() * 0.1, this.text_paint);
