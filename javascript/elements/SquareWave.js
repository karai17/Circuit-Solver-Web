...
class SquareWave {
    constructor(type, id, n1, n2) {
        ...
        this.elm = new Element2(id, type, global.utils.copy(global.PROPERTY.PROPERTY_SQUAREWAVE));
    ...
    build_element() {
        if ((this.build_element_flag || global.flags.flag_build_element) &&
            ...
            this.sq_0.x = this.c_x - (cache_2 >> 2) * global.utils.cosine(this.theta);
            this.sq_0.y = this.c_y - (cache_2 >> 2) * global.utils.sine(this.theta);
            this.sq_1.x = this.c_x + (cache_2 >> 2) * global.utils.cosine(this.theta);
            ...
            this.sq_3.x = this.sq_0.x - (cache_2 >> 1) * global.utils.cosine(this.theta_m90);
            this.sq_3.y = this.sq_0.y - (cache_2 >> 1) * global.utils.sine(this.theta_m90);
            this.sq_4.x = this.sq_1.x + (cache_2 >> 1) * global.utils.cosine(this.theta_m90);
            this.sq_4.y = this.sq_1.y + (cache_2 >> 1) * global.utils.sine(this.theta_m90);
            this.sq_5.x = this.sq_1.x - (cache_2 >> 1) * global.utils.cosine(this.theta_m90);
            this.sq_5.y = this.sq_1.y - (cache_2 >> 1) * global.utils.sine(this.theta_m90);
