...
class NOTGate {
    ...
    build_element() {
        if ((this.build_element_flag || global.flags.flag_build_element) &&
            ...
            let cache_1 = 1.3 * this.y_space;
            let cache_2 = 1.6 * this.x_space;
        ...
        if (global.flags.flag_picture_request ||
            ...
            if (global.variables.workspace_zoom_scale > 1.085 || (!MOBILE_MODE && global.variables.workspace_zoom_scale >= 0.99)) {
                ...
                if ((this.angle > 170 && this.angle < 190) || (this.angle > -10 && this.angle < 10)) {
                    canvas.draw_text(global.TEMPLATES.ELEMENT_VAL_TEMPLATE.replace('{VAL}', global.utils.exponentiate_quickly(this.elm.properties['High Voltage'])).replace('{UNIT}', this.elm.properties['units']), this.c_x, this.bounds.top + this.bounds.get_height() * 0.1, this.text_paint);
