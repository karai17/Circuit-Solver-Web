    ...
    update() {
        if (global.flags.flag_simulating && simulation_manager.solutions_ready && simulation_manager.simulation_step !== 0) {
            if (this.elm.consistent()) {
                ...
                this.elm.properties['Output Voltage'] = global.utils.limit(this.elm.properties['Input Voltage'] * this.elm.properties['LSB'], 0, this.elm.properties['Reference Voltage'] - this.elm.properties['LSB']);
            }
        }
    }
    stamp() {
