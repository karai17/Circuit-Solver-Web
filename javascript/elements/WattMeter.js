...
class WattMeter {
    constructor(type, id, n1, n2, n3) {
        ...
        this.elm = new Element3(id, type, global.utils.copy(global.PROPERTY.PROPERTY_WATTMETER));
        ...
        if (this.elm.consistent()) {
            ...
            this.trace_bounds.set_bounds(this.c_x - global.variables.node_space_x, this.c_y - 2 * global.variables.node_space_y, this.c_x + global.variables.node_space_x, this.c_y - 1 * global.variables.node_space_y);
    ...
    build_element() {
        if ((this.build_element_flag || global.flags.flag_build_element) &&
            ...
            this.wattmeter_0.x = this.p1.x + cache_4 * global.utils.cosine(this.theta_m90);
            this.wattmeter_0.y = this.p1.y + cache_5 * global.utils.sine(this.theta_m90);
            this.wattmeter_1.x = this.wattmeter_0.x + cache_8 * global.utils.cosine(this.theta);
            this.wattmeter_1.y = this.wattmeter_0.y + cache_9 * global.utils.sine(this.theta);
            this.wattmeter_2.x = this.wattmeter_1.x + cache_6 * global.utils.cosine(this.theta - Math.PI);
            this.wattmeter_2.y = this.wattmeter_1.y + cache_7 * global.utils.sine(this.theta - Math.PI);
            this.wattmeter_3.x = this.p2.x + cache_4 * global.utils.cosine(this.theta_m90);
            this.wattmeter_3.y = this.p2.y + cache_5 * global.utils.sine(this.theta_m90);
            this.wattmeter_4.x = this.wattmeter_3.x - cache_8 * global.utils.cosine(this.theta);
            this.wattmeter_4.y = this.wattmeter_3.y - cache_9 * global.utils.sine(this.theta);
            this.wattmeter_5.x = this.wattmeter_4.x + cache_6 * global.utils.cosine(this.theta);
            this.wattmeter_5.y = this.wattmeter_4.y + cache_7 * global.utils.sine(this.theta);
            this.wattmeter_6.x = this.p3.x - cache_8 * global.utils.cosine(this.theta_m90);
            this.wattmeter_6.y = this.p3.y - cache_9 * global.utils.sine(this.theta_m90);
            this.meter_symbol.set_bounds(this.bounds.left + this.bounds.get_width() * 0.4, this.bounds.top + this.bounds.get_height() * 0.4, this.bounds.right - this.bounds.get_width() * 0.4, this.bounds.bottom - this.bounds.get_height() * 0.4);
        ...
        if (this.build_element_flag || global.flags.flag_build_element || this.resize_meter_trace) {
            if (this.bounds.anchored) {
                if (this.elm.consistent()) {
                    ...
                    this.bounds.set_center2(this.equilateral_center[0], this.equilateral_center[1], global.variables.node_space_x * 2, global.variables.node_space_y * 2);
                    this.refactor();
                    this.trace_bounds.set_bounds(this.c_x - global.variables.node_space_x, this.c_y - 2 * global.variables.node_space_y, this.c_x + global.variables.node_space_x, this.c_y - global.variables.node_space_y);
                    this.meter_trace.update_parameters(this.trace_bounds, this.ratio, this.trace_bounds.get_width(), this.trace_bounds.get_height(), 0);
                }
                this.unanchor_wires();
                this.anchor_wires();
