...
var left_panel = document.getElementById('id_left_panel');
var center_panel = document.getElementById('id_center_panel');
var right_panel = document.getElementById('id_right_panel');
...
function load_app() {
    ...
    function resize_canvas(override) {
        try {
            ...
            temp = global.TEMPLATES.PIXEL_TEMPLATE.replace('{VALUE}', center_panel_width);
