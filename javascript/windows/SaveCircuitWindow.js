...
class SaveCircuitWindow {
    ...
    zoom_save_restore(canvas) {
        let previous_zoom = global.variables.workspace_zoom_scale;
        let x_offset = global.variables.x_offset;
        let y_offset = global.variables.y_offset;
        let delta_x = global.variables.delta_x;
        ...
        let node_space_x = 0.29375 * global.variables.node_space_x;
        let node_space_y = 0.29375 * global.variables.node_space_y;
