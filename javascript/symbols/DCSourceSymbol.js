...
class DCSourceSymbol {
    constructor(rect, index, page) {
        ...
        this.TAG = language_manager.TAG_DCSOURCE;
        this.draw_tag = false;
    ...
    build_element() {
        this.dc_0.x = this.c_x + this.x_space * 0.5 * global.utils.cosine(this.theta) + (this.x_space >> 2) * global.utils.cosine(this.theta_m90);
        this.dc_0.y = this.c_y + this.y_space * 0.5 * global.utils.sine(this.theta) + (this.x_space >> 2) * global.utils.sine(this.theta_m90);
        this.dc_1.x = this.c_x + this.x_space * 0.5 * global.utils.cosine(this.theta) + (this.x_space >> 2) * global.utils.cosine(Math.PI + this.theta_m90);
        this.dc_1.y = this.c_y + this.y_space * 0.5 * global.utils.sine(this.theta) + (this.x_space >> 2) * global.utils.sine(Math.PI + this.theta_m90);
        this.dc_2.x = this.c_x - this.x_space * 0.57142 * global.utils.cosine(this.theta);
        this.dc_2.y = this.c_y - this.y_space * 0.57142 * global.utils.sine(this.theta);
        this.dc_3.x = this.c_x - this.x_space * 0.25 * global.utils.cosine(this.theta) + (this.x_space >> 2) * global.utils.cosine(this.theta_m90);
        this.dc_3.y = this.c_y - this.y_space * 0.25 * global.utils.sine(this.theta) + (this.x_space >> 2) * global.utils.sine(this.theta_m90);
        this.dc_4.x = this.c_x - this.x_space * 0.25 * global.utils.cosine(this.theta) + (this.x_space >> 2) * global.utils.cosine(Math.PI + this.theta_m90);
        this.dc_4.y = this.c_y - this.y_space * 0.25 * global.utils.sine(this.theta) + (this.x_space >> 2) * global.utils.sine(Math.PI + this.theta_m90);
        this.dc_5.x = this.c_x + this.x_space * 0.0625 * global.utils.cosine(this.theta);
        this.dc_5.y = this.c_y + this.y_space * 0.0625 * global.utils.sine(this.theta);
    ...
    draw_symbol(canvas, page) {
        ...
        if (this.page === page) {
            ...
            this.circle_buffer = [];
            this.line_buffer = [];
            this.line_buffer[indexer++] = Array(this.dc_0.x, this.dc_0.y, this.dc_1.x, this.dc_1.y);
            this.line_buffer[indexer++] = Array(this.dc_2.x, this.dc_2.y, this.dc_5.x, this.dc_5.y);
            this.line_buffer[indexer++] = Array(this.dc_3.x, this.dc_3.y, this.dc_4.x, this.dc_4.y);
