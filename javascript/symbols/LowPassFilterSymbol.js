...
class LowPassFilterSymbol {
    ...
    draw_symbol(canvas, page) {
        ...
        if (this.page === page) {
            ...
            this.circle_buffer = [];
            this.line_buffer = [];
            this.line_buffer[indexer++] = Array(this.lpf_0.x, this.lpf_0.y, this.lpf_2.x, this.lpf_2.y);
            this.line_buffer[indexer++] = Array(this.lpf_2.x, this.lpf_2.y, this.lpf_3.x, this.lpf_3.y);
            this.line_buffer[indexer++] = Array(this.lpf_3.x, this.lpf_3.y, this.lpf_4.x, this.lpf_4.y);
            this.line_buffer[indexer++] = Array(this.lpf_4.x, this.lpf_4.y, this.lpf_0.x, this.lpf_0.y);
