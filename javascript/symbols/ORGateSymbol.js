...
class ORGateSymbol {
    ...
    build_element() {
        this.or_0.x = this.p1.x + 1.5 * this.x_space * global.utils.cosine(this.theta);
        this.or_0.y = this.p1.y + 1.5 * this.y_space * global.utils.sine(this.theta);
        this.or_1.x = this.or_0.x + 0.75 * this.x_space * global.utils.cosine(this.theta_m90);
        this.or_1.y = this.or_0.y + 0.75 * this.y_space * global.utils.sine(this.theta_m90);
        this.or_2.x = this.or_1.x + 0.75 * this.x_space * global.utils.cosine(this.theta - Math.PI);
        this.or_2.y = this.or_1.y + 0.75 * this.y_space * global.utils.sine(this.theta - Math.PI);
        this.or_7.x = this.or_0.x + 1.05 * this.x_space * global.utils.cosine(this.theta_m90);
        this.or_7.y = this.or_0.y + 1.05 * this.y_space * global.utils.sine(this.theta_m90);
        this.or_3.x = this.p1.x + 2.5 * this.x_space * global.utils.cosine(this.theta);
        this.or_3.y = this.p1.y + 2.5 * this.y_space * global.utils.sine(this.theta);
        this.or_4.x = this.or_3.x + 0.75 * this.x_space * global.utils.cosine(this.theta_m90);
        this.or_4.y = this.or_3.y + 0.75 * this.y_space * global.utils.sine(this.theta_m90);
        this.or_5.x = this.or_4.x + 0.75 * this.x_space * global.utils.cosine(this.theta);
        this.or_5.y = this.or_4.y + 0.75 * this.y_space * global.utils.sine(this.theta);
        this.or_8.x = this.or_3.x + 1.05 * this.x_space * global.utils.cosine(this.theta_m90);
        this.or_8.y = this.or_3.y + 1.05 * this.y_space * global.utils.sine(this.theta_m90);
        this.or_6.x = this.p3.x - 0.75 * this.x_space * global.utils.cosine(this.theta_m90);
        this.or_6.y = this.p3.y - 0.75 * this.y_space * global.utils.sine(this.theta_m90);
    }
    resize(rect) {
        this.bounds.set_bounds(rect.left, rect.top, rect.right, rect.bottom);
        this.c_x = this.bounds.get_center_x();
