'use strict';
class NPNBipolarJunctionTransistorSymbol {
	...
	private p2: PointF;
	private p3: PointF;
	private npn_0: PointF;
	private npn_1: PointF;
	private npn_2: PointF;
	private npn_3: PointF;
	private npn_4: PointF;
	private npn_5: PointF;
	private npn_6: PointF;
	private npn_7: PointF;
	private npn_8: PointF;
	private c_x: number;
	private c_y: number;
	...
	constructor(rect: RectF, index: number, page: number) {
		...
		this.TAG = language_manager.TAG_NPN;
		this.draw_tag = false;
	...
	draw_symbol(canvas: GraphicsEngine, page: number) {
		...
		if (this.page === page) {
			...
			this.circle_buffer = [];
			this.line_buffer = [];
			this.line_buffer[indexer++] = Array(this.p1.x, this.p1.y, this.npn_0.x, this.npn_0.y);
			this.line_buffer[indexer++] = Array(this.npn_0.x, this.npn_0.y, this.npn_1.x, this.npn_1.y);
			this.line_buffer[indexer++] = Array(this.p2.x, this.p2.y, this.npn_3.x, this.npn_3.y);
			this.line_buffer[indexer++] = Array(this.npn_3.x, this.npn_3.y, this.npn_4.x, this.npn_4.y);
			this.line_buffer[indexer++] = Array(this.npn_1.x, this.npn_1.y, this.npn_4.x, this.npn_4.y);
			this.line_buffer[indexer++] = Array(this.npn_2.x, this.npn_2.y, this.npn_5.x, this.npn_5.y);
			this.line_buffer[indexer++] = Array(this.npn_6.x, this.npn_6.y, this.p3.x, this.p3.y);
			this.line_buffer[indexer++] = Array(this.npn_3.x, this.npn_3.y, this.npn_7.x, this.npn_7.y);
			this.line_buffer[indexer++] = Array(this.npn_3.x, this.npn_3.y, this.npn_8.x, this.npn_8.y);
