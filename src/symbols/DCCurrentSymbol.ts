...
class DCCurrentSymbol {
	...
	build_element() {
		this.dcc_0.x = this.c_x - this.x_space * 0.5 * global.utils.cosine(this.theta);
		this.dcc_0.y = this.c_y - this.y_space * 0.5 * global.utils.sine(this.theta);
		this.dcc_1.x = this.c_x + this.x_space * 0.5 * global.utils.cosine(this.theta);
		this.dcc_1.y = this.c_y + this.y_space * 0.5 * global.utils.sine(this.theta);
		this.dcc_2.x = this.c_x - this.x_space * 0.125 * global.utils.cosine(this.theta) + (this.y_space >> 1) * global.utils.cosine(this.theta_m90);
		this.dcc_2.y = this.c_y - this.y_space * 0.125 * global.utils.sine(this.theta) + (this.y_space >> 1) * global.utils.sine(this.theta_m90);
		this.dcc_3.x = this.c_x - this.x_space * 0.125 * global.utils.cosine(this.theta) + (this.y_space >> 1) * global.utils.cosine(Math.PI + this.theta_m90);
		this.dcc_3.y = this.c_y - this.y_space * 0.125 * global.utils.sine(this.theta) + (this.y_space >> 1) * global.utils.sine(Math.PI + this.theta_m90);
