...
class IntegratorModuleSymbol {
	...
	private integ_0: PointF;
	private integ_1: PointF;
	private integ_2: PointF;
	private integ_3: PointF;
	private integ_4: PointF;
	private integ_5: PointF;
	private c_x: number;
	private c_y: number;
	...
	constructor(rect: RectF, index: number, page: number) {
		...
		this.TAG = language_manager.TAG_INTEGRATOR;
		this.draw_tag = false;
	...
	build_element() {
		this.integ_0.x = this.c_x - this.x_space * global.utils.cosine(this.theta) + this.x_space * global.utils.cosine(this.theta_m90);
		this.integ_0.y = this.c_y - this.y_space * global.utils.sine(this.theta) + this.y_space * global.utils.sine(this.theta_m90);
		this.integ_2.x = this.c_x - this.x_space * global.utils.cosine(this.theta) - this.x_space * global.utils.cosine(this.theta_m90);
		this.integ_2.y = this.c_y - this.y_space * global.utils.sine(this.theta) - this.y_space * global.utils.sine(this.theta_m90);
		this.integ_3.x = this.c_x + this.x_space * global.utils.cosine(this.theta) - this.x_space * global.utils.cosine(this.theta_m90);
		this.integ_3.y = this.c_y + this.y_space * global.utils.sine(this.theta) - this.y_space * global.utils.sine(this.theta_m90);
		this.integ_4.x = this.c_x + this.x_space * global.utils.cosine(this.theta) + this.x_space * global.utils.cosine(this.theta_m90);
		this.integ_4.y = this.c_y + this.y_space * global.utils.sine(this.theta) + this.y_space * global.utils.sine(this.theta_m90);
		this.integ_5.x = this.c_x + this.x_space * global.utils.cosine(this.theta);
		this.integ_5.y = this.c_y + this.y_space * global.utils.sine(this.theta);
	...
	draw_symbol(canvas: GraphicsEngine, page: number) {
		...
		if (this.page === page) {
			...
			this.circle_buffer = [];
			this.line_buffer = [];
			this.line_buffer[indexer++] = Array(this.integ_0.x, this.integ_0.y, this.integ_2.x, this.integ_2.y);
			this.line_buffer[indexer++] = Array(this.integ_2.x, this.integ_2.y, this.integ_3.x, this.integ_3.y);
			this.line_buffer[indexer++] = Array(this.integ_3.x, this.integ_3.y, this.integ_4.x, this.integ_4.y);
			this.line_buffer[indexer++] = Array(this.integ_4.x, this.integ_4.y, this.integ_0.x, this.integ_0.y);
