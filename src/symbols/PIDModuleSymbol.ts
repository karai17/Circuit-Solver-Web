...
class PIDModuleSymbol {
	...
	build_element() {
		this.pid_0.x = this.p1.x + 2.0 * this.x_space * global.utils.cosine(this.theta_m90);
		this.pid_0.y = this.p1.y + 2.0 * this.y_space * global.utils.sine(this.theta_m90);
		this.pid_1.x = this.pid_0.x + this.x_space * global.utils.cosine(this.theta);
		this.pid_1.y = this.pid_0.y + this.y_space * global.utils.sine(this.theta);
		this.pid_2.x = this.pid_1.x + 0.75 * this.x_space * global.utils.cosine(this.theta - Math.PI);
		this.pid_2.y = this.pid_1.y + 0.75 * this.y_space * global.utils.sine(this.theta - Math.PI);
		this.pid_3.x = this.p2.x + 2.0 * this.x_space * global.utils.cosine(this.theta_m90);
		this.pid_3.y = this.p2.y + 2.0 * this.y_space * global.utils.sine(this.theta_m90);
		this.pid_4.x = this.pid_3.x - this.x_space * global.utils.cosine(this.theta);
		this.pid_4.y = this.pid_3.y - this.y_space * global.utils.sine(this.theta);
		this.pid_5.x = this.pid_4.x + 0.75 * this.x_space * global.utils.cosine(this.theta);
		this.pid_5.y = this.pid_4.y + 0.75 * this.y_space * global.utils.sine(this.theta);
		this.pid_6.x = this.p3.x - this.x_space * global.utils.cosine(this.theta_m90);
		this.pid_6.y = this.p3.y - this.y_space * global.utils.sine(this.theta_m90);
	}
	resize(rect: RectF) {
		this.bounds.set_bounds(rect.left, rect.top, rect.right, rect.bottom);
		this.c_x = this.bounds.get_center_x();
