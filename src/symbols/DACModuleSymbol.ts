...
class DACModuleSymbol {
	...
	constructor(rect: RectF, index: number, page: number) {
		...
		this.TAG = language_manager.TAG_DAC;
		this.draw_tag = false;
	...
	build_element() {
		this.dac_0.x = this.c_x - this.x_space * global.utils.cosine(this.theta) + this.x_space * global.utils.cosine(this.theta_m90);
		this.dac_0.y = this.c_y - this.y_space * global.utils.sine(this.theta) + this.y_space * global.utils.sine(this.theta_m90);
		this.dac_2.x = this.c_x - this.x_space * global.utils.cosine(this.theta) - this.x_space * global.utils.cosine(this.theta_m90);
		this.dac_2.y = this.c_y - this.y_space * global.utils.sine(this.theta) - this.y_space * global.utils.sine(this.theta_m90);
		this.dac_3.x = this.c_x + this.x_space * global.utils.cosine(this.theta) - this.x_space * global.utils.cosine(this.theta_m90);
		this.dac_3.y = this.c_y + this.y_space * global.utils.sine(this.theta) - this.y_space * global.utils.sine(this.theta_m90);
		this.dac_4.x = this.c_x + this.x_space * global.utils.cosine(this.theta) + this.x_space * global.utils.cosine(this.theta_m90);
		this.dac_4.y = this.c_y + this.y_space * global.utils.sine(this.theta) + this.y_space * global.utils.sine(this.theta_m90);
		this.dac_5.x = this.c_x + this.x_space * global.utils.cosine(this.theta);
		this.dac_5.y = this.c_y + this.y_space * global.utils.sine(this.theta);
	...
	draw_symbol(canvas: GraphicsEngine, page: number) {
		...
		if (this.page === page) {
			...
			this.circle_buffer = [];
			this.line_buffer = [];
			this.line_buffer[indexer++] = Array(this.dac_0.x, this.dac_0.y, this.dac_2.x, this.dac_2.y);
			this.line_buffer[indexer++] = Array(this.dac_2.x, this.dac_2.y, this.dac_3.x, this.dac_3.y);
			this.line_buffer[indexer++] = Array(this.dac_3.x, this.dac_3.y, this.dac_4.x, this.dac_4.y);
			this.line_buffer[indexer++] = Array(this.dac_4.x, this.dac_4.y, this.dac_0.x, this.dac_0.y);
