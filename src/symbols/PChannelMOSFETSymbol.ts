...
class PChannelMOSFETSymbol {
	...
	build_element() {
		this.pmos_0.x = this.p1.x + this.x_space * global.utils.cosine(this.theta);
		this.pmos_0.y = this.p1.y + this.y_space * global.utils.sine(this.theta);
		this.pmos_1.x = this.pmos_0.x + 2 * this.x_space * global.utils.cosine(this.theta_m90);
		this.pmos_1.y = this.pmos_0.y + 2 * this.y_space * global.utils.sine(this.theta_m90);
		this.pmos_2.x = this.p1.x + 1.5 * this.x_space * global.utils.cosine(this.theta) + 2.5 * this.x_space * global.utils.cosine(this.theta_m90);
		this.pmos_2.y = this.p1.y + 1.5 * this.y_space * global.utils.sine(this.theta) + 2.5 * this.y_space * global.utils.sine(this.theta_m90);
		this.pmos_3.x = this.p1.x + 3.0 * this.x_space * global.utils.cosine(this.theta);
		this.pmos_3.y = this.p1.y + 3.0 * this.y_space * global.utils.sine(this.theta);
		this.pmos_4.x = this.pmos_3.x + 2 * this.x_space * global.utils.cosine(this.theta_m90);
		this.pmos_4.y = this.pmos_3.y + 2 * this.y_space * global.utils.sine(this.theta_m90);
		this.pmos_5.x = this.p1.x + 2.5 * this.x_space * global.utils.cosine(this.theta) + 2.5 * this.x_space * global.utils.cosine(this.theta_m90);
	...
	draw_symbol(canvas: GraphicsEngine, page: number) {
		...
		if (this.page === page) {
			...
			this.circle_buffer = [];
			this.line_buffer = [];
			this.line_buffer[indexer++] = Array(this.p1.x, this.p1.y, this.pmos_0.x, this.pmos_0.y);
			this.line_buffer[indexer++] = Array(this.pmos_0.x, this.pmos_0.y, this.pmos_1.x, this.pmos_1.y);
			this.line_buffer[indexer++] = Array(this.p2.x, this.p2.y, this.pmos_3.x, this.pmos_3.y);
			this.line_buffer[indexer++] = Array(this.pmos_3.x, this.pmos_3.y, this.pmos_4.x, this.pmos_4.y);
			this.line_buffer[indexer++] = Array(this.pmos_1.x, this.pmos_1.y, this.pmos_4.x, this.pmos_4.y);
			this.line_buffer[indexer++] = Array(this.pmos_2.x, this.pmos_2.y, this.pmos_5.x, this.pmos_5.y);
			this.line_buffer[indexer++] = Array(this.pmos_6.x, this.pmos_6.y, this.p3.x, this.p3.y);
			this.line_buffer[indexer++] = Array(this.pmos_1.x, this.pmos_1.y, this.pmos_7.x, this.pmos_7.y);
			this.line_buffer[indexer++] = Array(this.pmos_1.x, this.pmos_1.y, this.pmos_8.x, this.pmos_8.y);
