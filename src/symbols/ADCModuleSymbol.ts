...
class ADCModuleSymbol {
	...
	constructor(rect: RectF, index: number, page: number) {
		...
		this.TAG = language_manager.TAG_ADC;
		this.draw_tag = false;
	...
	build_element() {
		this.adc_0.x = this.c_x - this.x_space * global.utils.cosine(this.theta) + this.x_space * global.utils.cosine(this.theta_m90);
		this.adc_0.y = this.c_y - this.y_space * global.utils.sine(this.theta) + this.y_space * global.utils.sine(this.theta_m90);
		this.adc_2.x = this.c_x - this.x_space * global.utils.cosine(this.theta) - this.x_space * global.utils.cosine(this.theta_m90);
		this.adc_2.y = this.c_y - this.y_space * global.utils.sine(this.theta) - this.y_space * global.utils.sine(this.theta_m90);
		this.adc_3.x = this.c_x + this.x_space * global.utils.cosine(this.theta) - this.x_space * global.utils.cosine(this.theta_m90);
		this.adc_3.y = this.c_y + this.y_space * global.utils.sine(this.theta) - this.y_space * global.utils.sine(this.theta_m90);
		this.adc_4.x = this.c_x + this.x_space * global.utils.cosine(this.theta) + this.x_space * global.utils.cosine(this.theta_m90);
		this.adc_4.y = this.c_y + this.y_space * global.utils.sine(this.theta) + this.y_space * global.utils.sine(this.theta_m90);
		this.adc_5.x = this.c_x + this.x_space * global.utils.cosine(this.theta);
		this.adc_5.y = this.c_y + this.y_space * global.utils.sine(this.theta);
	...
	draw_symbol(canvas: GraphicsEngine, page: number) {
		...
		if (this.page === page) {
			...
			this.circle_buffer = [];
			this.line_buffer = [];
			this.line_buffer[indexer++] = Array(this.adc_0.x, this.adc_0.y, this.adc_2.x, this.adc_2.y);
			this.line_buffer[indexer++] = Array(this.adc_2.x, this.adc_2.y, this.adc_3.x, this.adc_3.y);
			this.line_buffer[indexer++] = Array(this.adc_3.x, this.adc_3.y, this.adc_4.x, this.adc_4.y);
			this.line_buffer[indexer++] = Array(this.adc_4.x, this.adc_4.y, this.adc_0.x, this.adc_0.y);
