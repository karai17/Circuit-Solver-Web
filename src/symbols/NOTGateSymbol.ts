...
class NOTGateSymbol {
	...
	constructor(rect: RectF, index: number, page: number) {
		...
		this.TAG = language_manager.TAG_NOT;
		this.draw_tag = false;
	...
	build_element() {
		this.not_0.x = this.c_x - this.x_space * global.utils.cosine(this.theta) + this.x_space * global.utils.cosine(this.theta_m90);
		this.not_0.y = this.c_y - this.x_space * global.utils.sine(this.theta) + this.x_space * global.utils.sine(this.theta_m90);
		this.not_1.x = this.c_x - this.x_space * global.utils.cosine(this.theta) - this.x_space * global.utils.cosine(this.theta_m90);
		this.not_1.y = this.c_y - this.x_space * global.utils.sine(this.theta) - this.x_space * global.utils.sine(this.theta_m90);
		this.not_2.x = this.c_x + this.x_space * global.utils.cosine(this.theta);
		this.not_2.y = this.c_y + this.x_space * global.utils.sine(this.theta);
		this.not_3.x = this.c_x + this.x_space * 1.3 * global.utils.cosine(this.theta);
		this.not_3.y = this.c_y + this.x_space * 1.3 * global.utils.sine(this.theta);
		...
		this.connect2_x = this.c_x + 1.6 * this.x_space * global.utils.cosine(this.theta);
		this.connect2_y = this.c_y + 1.6 * this.y_space * global.utils.sine(this.theta);
	}
	resize(rect: RectF) {
		this.bounds.set_bounds(rect.left, rect.top, rect.right, rect.bottom);
		this.c_x = this.bounds.get_center_x();
	...
	draw_symbol(canvas: GraphicsEngine, page: number) {
		...
		if (this.page === page) {
			...
			this.line_buffer[indexer++] = Array(this.not_0.x, this.not_0.y, this.not_2.x, this.not_2.y);
			this.line_buffer[indexer++] = Array(this.not_1.x, this.not_1.y, this.not_2.x, this.not_2.y);
			...
			indexer = 0;
			canvas.draw_circle(this.not_3.x, this.not_3.y, 1.3 * global.variables.canvas_stroke_width_2, this.line_paint);
