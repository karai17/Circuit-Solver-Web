...
class TPTZModuleSymbol {
	...
	private tptz_0: PointF;
	private tptz_1: PointF;
	private tptz_2: PointF;
	private tptz_3: PointF;
	private tptz_4: PointF;
	private tptz_5: PointF;
	private c_x: number;
	private c_y: number;
	...
	constructor(rect: RectF, index: number, page: number) {
		...
		this.TAG = language_manager.TAG_TPTZ;
		this.draw_tag = false;
	...
	build_element() {
		this.tptz_0.x = this.c_x - this.x_space * global.utils.cosine(this.theta) + this.x_space * global.utils.cosine(this.theta_m90);
		this.tptz_0.y = this.c_y - this.y_space * global.utils.sine(this.theta) + this.y_space * global.utils.sine(this.theta_m90);
		this.tptz_2.x = this.c_x - this.x_space * global.utils.cosine(this.theta) - this.x_space * global.utils.cosine(this.theta_m90);
		this.tptz_2.y = this.c_y - this.y_space * global.utils.sine(this.theta) - this.y_space * global.utils.sine(this.theta_m90);
		this.tptz_3.x = this.c_x + this.x_space * global.utils.cosine(this.theta) - this.x_space * global.utils.cosine(this.theta_m90);
		this.tptz_3.y = this.c_y + this.y_space * global.utils.sine(this.theta) - this.y_space * global.utils.sine(this.theta_m90);
		this.tptz_4.x = this.c_x + this.x_space * global.utils.cosine(this.theta) + this.x_space * global.utils.cosine(this.theta_m90);
		this.tptz_4.y = this.c_y + this.y_space * global.utils.sine(this.theta) + this.y_space * global.utils.sine(this.theta_m90);
		this.tptz_5.x = this.c_x + this.x_space * global.utils.cosine(this.theta);
		this.tptz_5.y = this.c_y + this.y_space * global.utils.sine(this.theta);
	...
	draw_symbol(canvas: GraphicsEngine, page: number) {
		...
		if (this.page === page) {
			...
			this.circle_buffer = [];
			this.line_buffer = [];
			this.line_buffer[indexer++] = Array(this.tptz_0.x, this.tptz_0.y, this.tptz_2.x, this.tptz_2.y);
			this.line_buffer[indexer++] = Array(this.tptz_2.x, this.tptz_2.y, this.tptz_3.x, this.tptz_3.y);
			this.line_buffer[indexer++] = Array(this.tptz_3.x, this.tptz_3.y, this.tptz_4.x, this.tptz_4.y);
			this.line_buffer[indexer++] = Array(this.tptz_4.x, this.tptz_4.y, this.tptz_0.x, this.tptz_0.y);
