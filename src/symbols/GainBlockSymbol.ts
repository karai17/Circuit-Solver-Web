...
class GainBlockSymbol {
	...
	build_element() {
		this.gain_0.x = this.c_x - this.x_space * global.utils.cosine(this.theta) + this.x_space * global.utils.cosine(this.theta_m90);
		this.gain_0.y = this.c_y - this.x_space * global.utils.sine(this.theta) + this.x_space * global.utils.sine(this.theta_m90);
		this.gain_1.x = this.c_x - this.x_space * global.utils.cosine(this.theta) - this.x_space * global.utils.cosine(this.theta_m90);
		this.gain_1.y = this.c_y - this.x_space * global.utils.sine(this.theta) - this.x_space * global.utils.sine(this.theta_m90);
		this.gain_2.x = this.c_x + this.x_space * global.utils.cosine(this.theta);
		this.gain_2.y = this.c_y + this.x_space * global.utils.sine(this.theta);
		this.gain_3.x = this.c_x + this.x_space * 1.3 * global.utils.cosine(this.theta);
		this.gain_3.y = this.c_y + this.x_space * 1.3 * global.utils.sine(this.theta);
		this.gain_4.x = this.c_x - this.x_space * 0.4 * global.utils.cosine(this.theta);
		this.gain_4.y = this.c_y - this.x_space * 0.4 * global.utils.sine(this.theta);
