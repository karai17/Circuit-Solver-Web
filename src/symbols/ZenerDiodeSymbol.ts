...
class ZenerDiodeSymbol {
	...
	private zen_0: PointF;
	private zen_1: PointF;
	private zen_2: PointF;
	private zen_3: PointF;
	private zen_4: PointF;
	private zen_5: PointF;
	private c_x: number;
	private c_y: number;
	...
	constructor(rect: RectF, index: number, page: number) {
		...
		this.TAG = language_manager.TAG_ZENER;
		this.draw_tag = false;
	...
	build_element() {
		this.zen_0.x = this.c_x + (this.x_space >> 1) * global.utils.cosine(this.theta) + (this.x_space >> 1) * global.utils.cosine(this.theta_m90);
		this.zen_0.y = this.c_y + (this.y_space >> 1) * global.utils.sine(this.theta) + (this.y_space >> 1) * global.utils.sine(this.theta_m90);
		this.zen_4.x = this.c_x + (this.x_space >> 2) * global.utils.cosine(this.theta) + this.x_space * 0.7 * global.utils.cosine(this.theta_m90);
		this.zen_4.y = this.c_y + (this.y_space >> 2) * global.utils.sine(this.theta) + this.y_space * 0.7 * global.utils.sine(this.theta_m90);
		this.zen_1.x = this.c_x - (this.x_space >> 1) * global.utils.cosine(this.theta) + (this.x_space >> 1) * global.utils.cosine(this.theta_m90);
		this.zen_1.y = this.c_y - (this.y_space >> 1) * global.utils.sine(this.theta) + (this.y_space >> 1) * global.utils.sine(this.theta_m90);
		this.zen_3.x = this.c_x + (this.x_space >> 1) * global.utils.cosine(this.theta) + (this.x_space >> 1) * global.utils.cosine(Math.PI + this.theta_m90);
		this.zen_3.y = this.c_y + (this.y_space >> 1) * global.utils.sine(this.theta) + (this.y_space >> 1) * global.utils.sine(Math.PI + this.theta_m90);
		this.zen_5.x = this.c_x + this.x_space * 0.75 * global.utils.cosine(this.theta) + this.x_space * 0.7 * global.utils.cosine(Math.PI + this.theta_m90);
		this.zen_5.y = this.c_y + this.y_space * 0.75 * global.utils.sine(this.theta) + this.y_space * 0.7 * global.utils.sine(Math.PI + this.theta_m90);
		this.zen_2.x = this.c_x - (this.x_space >> 1) * global.utils.cosine(this.theta) + (this.x_space >> 1) * global.utils.cosine(Math.PI + this.theta_m90);
		this.zen_2.y = this.c_y - (this.y_space >> 1) * global.utils.sine(this.theta) + (this.y_space >> 1) * global.utils.sine(Math.PI + this.theta_m90);
	...
	draw_symbol(canvas: GraphicsEngine, page: number) {
		...
		if (this.page === page) {
			...
			this.circle_buffer = [];
			this.line_buffer = [];
			this.line_buffer[indexer++] = Array(this.zen_1.x, this.zen_1.y, this.zen_2.x, this.zen_2.y);
			this.line_buffer[indexer++] = Array(this.zen_3.x, this.zen_3.y, this.zen_0.x, this.zen_0.y);
			this.line_buffer[indexer++] = Array(this.zen_0.x, this.zen_0.y, this.zen_4.x, this.zen_4.y);
			this.line_buffer[indexer++] = Array(this.zen_3.x, this.zen_3.y, this.zen_5.x, this.zen_5.y);
			this.line_buffer[indexer++] = Array(this.zen_1.x, this.zen_1.y, this.connect2_x, this.connect2_y);
			this.line_buffer[indexer++] = Array(this.zen_2.x, this.zen_2.y, this.connect2_x, this.connect2_y);
