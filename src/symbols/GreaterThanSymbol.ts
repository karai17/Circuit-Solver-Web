...
class GreaterThanSymbol {
	...
	private p2: PointF;
	private p3: PointF;
	private greater_0: PointF;
	private greater_1: PointF;
	private greater_2: PointF;
	private greater_3: PointF;
	private greater_4: PointF;
	private greater_5: PointF;
	private greater_6: PointF;
	private greater_7: PointF;
	private greater_8: PointF;
	private greater_9: PointF;
	private c_x: number;
	private c_y: number;
	...
	constructor(rect: RectF, index: number, page: number) {
		...
		this.TAG = language_manager.TAG_GRT;
		this.draw_tag = false;
	...
	build_element() {
		this.greater_0.x = this.p1.x + 2.0 * this.x_space * global.utils.cosine(this.theta_m90);
		this.greater_0.y = this.p1.y + 2.0 * this.y_space * global.utils.sine(this.theta_m90);
		this.greater_1.x = this.greater_0.x + this.x_space * global.utils.cosine(this.theta);
		this.greater_1.y = this.greater_0.y + this.y_space * global.utils.sine(this.theta);
		this.greater_2.x = this.greater_1.x + 0.75 * this.x_space * global.utils.cosine(this.theta - Math.PI);
		this.greater_2.y = this.greater_1.y + 0.75 * this.y_space * global.utils.sine(this.theta - Math.PI);
		this.greater_3.x = this.p2.x + 2.0 * this.x_space * global.utils.cosine(this.theta_m90);
		this.greater_3.y = this.p2.y + 2.0 * this.y_space * global.utils.sine(this.theta_m90);
		this.greater_4.x = this.greater_3.x - this.x_space * global.utils.cosine(this.theta);
		this.greater_4.y = this.greater_3.y - this.y_space * global.utils.sine(this.theta);
		this.greater_5.x = this.greater_4.x + 0.75 * this.x_space * global.utils.cosine(this.theta);
		this.greater_5.y = this.greater_4.y + 0.75 * this.y_space * global.utils.sine(this.theta);
		this.greater_6.x = this.p3.x - this.x_space * global.utils.cosine(this.theta_m90);
		this.greater_6.y = this.p3.y - this.y_space * global.utils.sine(this.theta_m90);
		let adj_x = this.c_x - 0.25 * this.x_space * global.utils.cosine(this.theta_m90);
		let adj_y = this.c_y - 0.25 * this.y_space * global.utils.sine(this.theta_m90);
		this.greater_7.x = adj_x + 0.4 * this.x_space * global.utils.cosine(this.theta);
		this.greater_7.y = adj_y + 0.4 * this.y_space * global.utils.sine(this.theta);
		this.greater_8.x = adj_x + 0.6 * this.x_space * global.utils.cosine(this.theta_m90);
		this.greater_8.y = adj_y + 0.6 * this.y_space * global.utils.sine(this.theta_m90);
		this.greater_9.x = adj_x - 0.4 * this.x_space * global.utils.cosine(this.theta);
		this.greater_9.y = adj_y - 0.4 * this.y_space * global.utils.sine(this.theta);
	}
	resize(rect: RectF) {
		this.bounds.set_bounds(rect.left, rect.top, rect.right, rect.bottom);
		this.c_x = this.bounds.get_center_x();
	...
	draw_symbol(canvas: GraphicsEngine, page: number) {
		...
		if (this.page === page) {
			...
			this.line_buffer[indexer++] = Array(this.greater_0.x, this.greater_0.y, this.greater_1.x, this.greater_1.y);
			this.line_buffer[indexer++] = Array(this.p2.x, this.p2.y, this.greater_3.x, this.greater_3.y);
			this.line_buffer[indexer++] = Array(this.greater_3.x, this.greater_3.y, this.greater_4.x, this.greater_4.y);
			this.line_buffer[indexer++] = Array(this.greater_6.x, this.greater_6.y, this.p3.x, this.p3.y);
