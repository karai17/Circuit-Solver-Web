...
class ACCurrentSymbol {
	...
	constructor(rect: RectF, index: number, page: number) {
		...
		this.sine_wave.set_color(global.COLORS.GENERAL_WHITE_COLOR);
		this.build_element();
	...
	build_element() {
		this.acc_0.x = this.c_x - this.x_space * 0.5 * global.utils.cosine(this.theta);
		this.acc_0.y = this.c_y - this.y_space * 0.5 * global.utils.sine(this.theta);
		this.acc_1.x = this.c_x + this.x_space * 0.5 * global.utils.cosine(this.theta);
		this.acc_1.y = this.c_y + this.y_space * 0.5 * global.utils.sine(this.theta);
		this.acc_2.x = this.c_x - this.x_space * 0.125 * global.utils.cosine(this.theta) + (this.y_space >> 1) * global.utils.cosine(this.theta_m90);
		this.acc_2.y = this.c_y - this.y_space * 0.125 * global.utils.sine(this.theta) + (this.y_space >> 1) * global.utils.sine(this.theta_m90);
		this.acc_3.x = this.c_x - this.x_space * 0.125 * global.utils.cosine(this.theta) + (this.y_space >> 1) * global.utils.cosine(Math.PI + this.theta_m90);
		this.acc_3.y = this.c_y - this.y_space * 0.125 * global.utils.sine(this.theta) + (this.y_space >> 1) * global.utils.sine(Math.PI + this.theta_m90);
		this.sine_wave_p1.x = this.c_x + (this.x_space >> 2) * global.utils.cosine(this.theta) - (this.x_space >> 1) * global.utils.cosine(Math.PI + this.theta_m90);
		this.sine_wave_p1.y = this.c_y + (this.y_space >> 2) * global.utils.sine(this.theta) - (this.y_space >> 1) * global.utils.sine(Math.PI + this.theta_m90);
		this.sine_wave_p2.x = this.c_x + (this.x_space >> 2) * global.utils.cosine(this.theta) + (this.x_space >> 1) * global.utils.cosine(Math.PI + this.theta_m90);
		this.sine_wave_p2.y = this.c_y + (this.y_space >> 2) * global.utils.sine(this.theta) + (this.y_space >> 1) * global.utils.sine(Math.PI + this.theta_m90);
	...
	draw_symbol(canvas: GraphicsEngine, page: number) {
		...
		if (this.page === page) {
			...
			this.circle_buffer = [];
			this.line_buffer = [];
			this.line_buffer[indexer++] = Array(this.acc_0.x, this.acc_0.y, this.acc_1.x, this.acc_1.y);
			this.line_buffer[indexer++] = Array(this.acc_2.x, this.acc_2.y, this.acc_0.x, this.acc_0.y);
			this.line_buffer[indexer++] = Array(this.acc_0.x, this.acc_0.y, this.acc_3.x, this.acc_3.y);
