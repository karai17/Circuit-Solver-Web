...
class VoltageSaturationSymbol {
	...
	constructor(rect: RectF, index: number, page: number) {
		...
		this.TAG = language_manager.TAG_VSAT;
		this.draw_tag = false;
	...
	build_element() {
		this.vsat_0.x = this.c_x - this.x_space * global.utils.cosine(this.theta) + this.x_space * global.utils.cosine(this.theta_m90);
		this.vsat_0.y = this.c_y - this.y_space * global.utils.sine(this.theta) + this.y_space * global.utils.sine(this.theta_m90);
		this.vsat_2.x = this.c_x - this.x_space * global.utils.cosine(this.theta) - this.x_space * global.utils.cosine(this.theta_m90);
		this.vsat_2.y = this.c_y - this.y_space * global.utils.sine(this.theta) - this.y_space * global.utils.sine(this.theta_m90);
		this.vsat_3.x = this.c_x + this.x_space * global.utils.cosine(this.theta) - this.x_space * global.utils.cosine(this.theta_m90);
		this.vsat_3.y = this.c_y + this.y_space * global.utils.sine(this.theta) - this.y_space * global.utils.sine(this.theta_m90);
		this.vsat_4.x = this.c_x + this.x_space * global.utils.cosine(this.theta) + this.x_space * global.utils.cosine(this.theta_m90);
		this.vsat_4.y = this.c_y + this.y_space * global.utils.sine(this.theta) + this.y_space * global.utils.sine(this.theta_m90);
		this.vsat_5.x = this.c_x + this.x_space * global.utils.cosine(this.theta);
		this.vsat_5.y = this.c_y + this.y_space * global.utils.sine(this.theta);
	...
	draw_symbol(canvas: GraphicsEngine, page: number) {
		...
		if (this.page === page) {
			...
			this.circle_buffer = [];
			this.line_buffer = [];
			this.line_buffer[indexer++] = Array(this.vsat_0.x, this.vsat_0.y, this.vsat_2.x, this.vsat_2.y);
			this.line_buffer[indexer++] = Array(this.vsat_2.x, this.vsat_2.y, this.vsat_3.x, this.vsat_3.y);
			this.line_buffer[indexer++] = Array(this.vsat_3.x, this.vsat_3.y, this.vsat_4.x, this.vsat_4.y);
			this.line_buffer[indexer++] = Array(this.vsat_4.x, this.vsat_4.y, this.vsat_0.x, this.vsat_0.y);
			...
			this.line_buffer[indexer++] = Array(this.vsat_6.x, this.vsat_6.y, this.vsat_7.x, this.vsat_7.y);
			this.line_buffer[indexer++] = Array(this.vsat_7.x, this.vsat_7.y, this.vsat_9.x, this.vsat_9.y);
			this.line_buffer[indexer++] = Array(this.vsat_9.x, this.vsat_9.y, this.vsat_8.x, this.vsat_8.y);
