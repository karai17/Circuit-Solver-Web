'use strict';
class DifferentiatorModuleSymbol {
	...
	constructor(rect: RectF, index: number, page: number) {
		...
		this.TAG = language_manager.TAG_DIFFERENTIATOR;
		this.draw_tag = false;
	...
	build_element() {
		this.diff_0.x = this.c_x - this.x_space * global.utils.cosine(this.theta) + this.x_space * global.utils.cosine(this.theta_m90);
		this.diff_0.y = this.c_y - this.y_space * global.utils.sine(this.theta) + this.y_space * global.utils.sine(this.theta_m90);
		this.diff_2.x = this.c_x - this.x_space * global.utils.cosine(this.theta) - this.x_space * global.utils.cosine(this.theta_m90);
		this.diff_2.y = this.c_y - this.y_space * global.utils.sine(this.theta) - this.y_space * global.utils.sine(this.theta_m90);
		this.diff_3.x = this.c_x + this.x_space * global.utils.cosine(this.theta) - this.x_space * global.utils.cosine(this.theta_m90);
		this.diff_3.y = this.c_y + this.y_space * global.utils.sine(this.theta) - this.y_space * global.utils.sine(this.theta_m90);
		this.diff_4.x = this.c_x + this.x_space * global.utils.cosine(this.theta) + this.x_space * global.utils.cosine(this.theta_m90);
		this.diff_4.y = this.c_y + this.y_space * global.utils.sine(this.theta) + this.y_space * global.utils.sine(this.theta_m90);
		this.diff_5.x = this.c_x + this.x_space * global.utils.cosine(this.theta);
		this.diff_5.y = this.c_y + this.y_space * global.utils.sine(this.theta);
	...
	draw_symbol(canvas: GraphicsEngine, page: number) {
		...
		if (this.page === page) {
			...
			this.circle_buffer = [];
			this.line_buffer = [];
			this.line_buffer[indexer++] = Array(this.diff_0.x, this.diff_0.y, this.diff_2.x, this.diff_2.y);
			this.line_buffer[indexer++] = Array(this.diff_2.x, this.diff_2.y, this.diff_3.x, this.diff_3.y);
			this.line_buffer[indexer++] = Array(this.diff_3.x, this.diff_3.y, this.diff_4.x, this.diff_4.y);
			this.line_buffer[indexer++] = Array(this.diff_4.x, this.diff_4.y, this.diff_0.x, this.diff_0.y);
