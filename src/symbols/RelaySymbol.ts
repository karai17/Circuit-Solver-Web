...
class RelaySymbol {
	...
	build_element() {
		this.relay_0.x = this.p1.x + this.x_space * global.utils.cosine(this.theta_m90);
		this.relay_0.y = this.p1.y + this.y_space * global.utils.sine(this.theta_m90);
		this.relay_1.x = this.p2.x + this.x_space * global.utils.cosine(this.theta_m90);
		this.relay_1.y = this.p2.y + this.y_space * global.utils.sine(this.theta_m90);
		this.relay_2.x = this.p1.x + 3.0 * this.x_space * global.utils.cosine(this.theta_m90);
		this.relay_2.y = this.p1.y + 3.0 * this.y_space * global.utils.sine(this.theta_m90);
		this.relay_3.x = this.p2.x + 3.0 * this.x_space * global.utils.cosine(this.theta_m90);
		this.relay_3.y = this.p2.y + 3.0 * this.y_space * global.utils.sine(this.theta_m90);
		this.relay_4.x = this.relay_0.x + this.x_space * global.utils.cosine(this.theta);
		this.relay_4.y = this.relay_0.y + this.y_space * global.utils.sine(this.theta);
		this.relay_5.x = this.relay_0.x + 2.0 * this.x_space * global.utils.cosine(this.theta);
		this.relay_5.y = this.relay_0.y + 2.0 * this.y_space * global.utils.sine(this.theta);
		this.relay_6.x = this.relay_0.x + 3.0 * this.x_space * global.utils.cosine(this.theta);
		this.relay_6.y = this.relay_0.y + 3.0 * this.y_space * global.utils.sine(this.theta);
		this.relay_7.x = this.relay_2.x + this.x_space * global.utils.cosine(this.theta);
		this.relay_7.y = this.relay_2.y + this.y_space * global.utils.sine(this.theta);
		this.relay_8.x = this.relay_2.x + 2.0 * this.x_space * global.utils.cosine(this.theta) + this.x_space * global.utils.cosine(this.theta_m90);
		this.relay_8.y = this.relay_2.y + 2.0 * this.y_space * global.utils.sine(this.theta) + this.y_space * global.utils.sine(this.theta_m90);
		this.relay_9.x = this.relay_2.x + 3.0 * this.x_space * global.utils.cosine(this.theta);
		this.relay_9.y = this.relay_2.y + 3.0 * this.y_space * global.utils.sine(this.theta);
		this.relay_10.x = this.relay_4.x - 0.75 * this.x_space * global.utils.cosine(this.theta_m90);
		this.relay_10.y = this.relay_4.y - 0.5 * this.y_space * global.utils.sine(this.theta_m90);
		this.relay_11.y = this.relay_7.y + 0.75 * this.y_space * global.utils.sine(this.theta_m90);
		this.relay_11.x = this.relay_7.x + 0.75 * this.x_space * global.utils.cosine(this.theta_m90);
	}
	resize(rect: RectF) {
		this.bounds.set_bounds(rect.left, rect.top, rect.right, rect.bottom);
		this.c_x = this.bounds.get_center_x();
