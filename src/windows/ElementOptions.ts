...
class ElementOptions {
	...
	private readonly ROTATE_ICON: number;
	public readonly EDIT_ICON: number;
	private readonly FLIP_ICON: number;
	private readonly TRASH_ICON: number;
	private readonly WIRE_ICON: number;
	public readonly EYE_ICON: number;
	private readonly NO_ICON: number;
	private mb_x: number;
	private mb_width: number;
	private mb_height: number;
	private option_0: RectF;
	private option_1: RectF;
	private option_2: RectF;
	private option_3: RectF;
	private show_0: boolean;
	private show_1: boolean;
	private show_2: boolean;
	private show_3: boolean;
	private edit_path0: Path;
	private trash_path0: Path;
	private trash_path1: Path;
	private flip_path0: Path;
	private flip_path1: Path;
	private line_paint: Paint;
	private fill_paint: Paint;
	private line_paint_alt: Paint;
	private meter_line_paint: Paint;
	private text_paint: Paint;
	private hover_paint: Paint;
	private icon_paint: Paint;
	...
	private width_mul_0p125: number;
	private height_mul_0p125: number;
	constructor() {
		...
		this.option_0 = new RectF(
			...
			menu_bar.bounds.bottom + global.variables.canvas_stroke_width_3,
			this.mb_x + this.mb_width * 0.5,
			menu_bar.bounds.bottom + global.variables.canvas_stroke_width_3 + this.mb_height
		);
		this.option_1 = new RectF(
			this.mb_x - this.mb_width * 0.5,
			this.option_0.bottom + global.variables.canvas_stroke_width_3,
			this.mb_x + this.mb_width * 0.5,
			this.option_0.bottom + global.variables.canvas_stroke_width_3 + this.mb_height
		);
		this.option_2 = new RectF(
			this.mb_x - this.mb_width * 0.5,
			this.option_1.bottom + global.variables.canvas_stroke_width_3,
			this.mb_x + this.mb_width * 0.5,
			this.option_1.bottom + global.variables.canvas_stroke_width_3 + this.mb_height
		);
		this.option_3 = new RectF(
			this.mb_x - this.mb_width * 0.5,
			this.option_2.bottom + global.variables.canvas_stroke_width_3,
			this.mb_x + this.mb_width * 0.5,
			this.option_2.bottom + global.variables.canvas_stroke_width_3 + this.mb_height
		);
		this.show_0 = false;
		this.show_1 = false;
		this.show_2 = false;
		...
		this.icon_paint.set_paint_join(paint.join.ROUND);
	...
	draw_options(canvas: GraphicsEngine): void {
		if (global.flags.flag_idle && !global.flags.flag_menu_element_toolbox && !global.flags.flag_graph) {
			if (global.variables.selected) {
				if (this.show_0) {
					if (
						this.option_0.contains_xy(global.variables.mouse_x, global.variables.mouse_y) &&
						!global.flags.flag_menu_element_toolbox &&
						!global.flags.flag_zoom &&
						!global.flags.flag_select_settings &&
						!global.flags.flag_save_image &&
				...
				if (this.show_1) {
					if (
						this.option_1.contains_xy(global.variables.mouse_x, global.variables.mouse_y) &&
						!global.flags.flag_menu_element_toolbox &&
						!global.flags.flag_zoom &&
						!global.flags.flag_select_settings &&
						!global.flags.flag_save_image &&
				...
				if (this.show_2) {
					if (
						this.option_2.contains_xy(global.variables.mouse_x, global.variables.mouse_y) &&
						!global.flags.flag_menu_element_toolbox &&
						!global.flags.flag_zoom &&
						!global.flags.flag_select_settings &&
						!global.flags.flag_save_image &&
				...
				if (this.show_3) {
					if (
						this.option_3.contains_xy(global.variables.mouse_x, global.variables.mouse_y) &&
						!global.flags.flag_menu_element_toolbox &&
						!global.flags.flag_zoom &&
						!global.flags.flag_select_settings &&
						!global.flags.flag_save_image &&
