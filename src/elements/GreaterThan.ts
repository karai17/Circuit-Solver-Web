...
class GreaterThan {
	...
	constructor(type: number, id: number, n1: number, n2: number, n3: number) {
		...
		this.elm = new Element3(id, type, global.utils.copy(global.PROPERTY.PROPERTY_GRT));
	...
	build_element(): void {
		if (
			...
			this.greater_0.x = this.p1.x + cache_4 * global.utils.cosine(this.theta_m90);
			this.greater_0.y = this.p1.y + cache_5 * global.utils.sine(this.theta_m90);
			this.greater_1.x = this.greater_0.x + cache_14 * global.utils.cosine(this.theta);
			this.greater_1.y = this.greater_0.y + cache_15 * global.utils.sine(this.theta);
			this.greater_2.x = this.greater_1.x + cache_6 * global.utils.cosine(this.theta - Math.PI);
			this.greater_2.y = this.greater_1.y + cache_7 * global.utils.sine(this.theta - Math.PI);
			this.greater_3.x = this.p2.x + cache_4 * global.utils.cosine(this.theta_m90);
			this.greater_3.y = this.p2.y + cache_5 * global.utils.sine(this.theta_m90);
			this.greater_4.x = this.greater_3.x - cache_14 * global.utils.cosine(this.theta);
			this.greater_4.y = this.greater_3.y - cache_15 * global.utils.sine(this.theta);
			this.greater_5.x = this.greater_4.x + cache_6 * global.utils.cosine(this.theta);
			this.greater_5.y = this.greater_4.y + cache_7 * global.utils.sine(this.theta);
			this.greater_6.x = this.p3.x - cache_14 * global.utils.cosine(this.theta_m90);
			this.greater_6.y = this.p3.y - cache_15 * global.utils.sine(this.theta_m90);
			let adj_x = this.c_x - cache_8 * global.utils.cosine(this.theta_m90);
			let adj_y = this.c_y - cache_9 * global.utils.sine(this.theta_m90);
			this.greater_7.x = adj_x + cache_10 * global.utils.cosine(this.theta);
			this.greater_7.y = adj_y + cache_11 * global.utils.sine(this.theta);
			this.greater_8.x = adj_x + cache_12 * global.utils.cosine(this.theta_m90);
			this.greater_8.y = adj_y + cache_13 * global.utils.sine(this.theta_m90);
			this.greater_9.x = adj_x - cache_10 * global.utils.cosine(this.theta);
			this.greater_9.y = adj_y - cache_11 * global.utils.sine(this.theta);
	...
	draw_component(canvas: GraphicsEngine): void {
		...
		if (
			...
			this.circle_buffer[this.indexer++] = Array(this.plus_point.x, this.plus_point.y, global.variables.canvas_stroke_width_2_zoom);
	...
	patch(): void {
		if (!global.utils.not_null(this.plus_point)) {
			this.plus_point = new PointF(0, 0);
		}
