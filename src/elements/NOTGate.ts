...
class NOTGate {
	...
	private not_0: PointF;
	private not_2: PointF;
	private not_1: PointF;
	private not_3: PointF;
	private c_x: number;
	private c_y: number;
	...
	constructor(type: number, id: number, n1: number, n2: number) {
		...
		this.elm = new Element2(id, type, global.utils.copy(global.PROPERTY.PROPERTY_NOT));
		...
		this.not_2 = new PointF(0, 0);
		this.not_1 = new PointF(0, 0);
		this.not_3 = new PointF(0, 0);
	...
	build_element(): void {
		if (
			...
			let cache_1: number = 1.3 * this.y_space;
			let cache_2: number = 1.6 * this.x_space;
			let cache_3: number = 1.6 * this.y_space;
			let cache_4: number = this.x_space;
			let cache_5: number = this.y_space;
			this.not_0.x = this.c_x - cache_4 * global.utils.cosine(this.theta) + cache_4 * global.utils.cosine(this.theta_m90);
			this.not_0.y = this.c_y - cache_4 * global.utils.sine(this.theta) + cache_4 * global.utils.sine(this.theta_m90);
			this.not_1.x = this.c_x - cache_4 * global.utils.cosine(this.theta) - cache_4 * global.utils.cosine(this.theta_m90);
			this.not_1.y = this.c_y - cache_4 * global.utils.sine(this.theta) - cache_4 * global.utils.sine(this.theta_m90);
			this.not_2.x = this.c_x + cache_4 * global.utils.cosine(this.theta);
			this.not_2.y = this.c_y + cache_4 * global.utils.sine(this.theta);
			this.not_3.x = this.c_x + cache_0 * global.utils.cosine(this.theta);
			this.not_3.y = this.c_y + cache_1 * global.utils.sine(this.theta);
	...
	draw_component(canvas: GraphicsEngine): void {
		...
		if (
			...
			this.circle_buffer = [];
			this.line_buffer = [];
			this.line_buffer[this.indexer++] = Array(this.not_0.x, this.not_0.y, this.not_1.x, this.not_1.y);
			this.line_buffer[this.indexer++] = Array(this.not_0.x, this.not_0.y, this.not_2.x, this.not_2.y);
			this.line_buffer[this.indexer++] = Array(this.not_1.x, this.not_1.y, this.not_2.x, this.not_2.y);
			...
			this.indexer = 0;
			canvas.draw_circle(this.not_3.x, this.not_3.y, 1.3 * global.variables.canvas_stroke_width_2_zoom, this.line_paint);
