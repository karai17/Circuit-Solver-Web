...
class NChannelMOSFET {
	...
	private p2: PointF;
	private p3: PointF;
	private nmos_0: PointF;
	private nmos_1: PointF;
	private nmos_2: PointF;
	private nmos_3: PointF;
	private nmos_4: PointF;
	private nmos_5: PointF;
	private nmos_6: PointF;
	private nmos_7: PointF;
	private nmos_8: PointF;
	...
	update(): void {
		if (global.flags.flag_simulating && simulation_manager.solutions_ready) {
			if (this.elm.consistent()) {
				...
				let kn: number = 0.5 * this.elm.properties['W/L Ratio'] * this.elm.properties["K'n"];
