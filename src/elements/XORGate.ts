...
class XORGate {
	...
	private p2: PointF;
	private p3: PointF;
	private xor_0: PointF;
	private xor_1: PointF;
	private xor_2: PointF;
	private xor_3: PointF;
	private xor_4: PointF;
	private xor_5: PointF;
	private xor_6: PointF;
	private xor_7: PointF;
	private xor_8: PointF;
	private xor_9: PointF;
	private xor_10: PointF;
	...
	constructor(type: number, id: number, n1: number, n2: number, n3: number) {
		...
		this.elm = new Element3(id, type, global.utils.copy(global.PROPERTY.PROPERTY_XOR));
	...
	vout_xor(ui: Array<number>): number {
		let product = 1;
	...
	partial_xor(terminal: number, ui: Array<number>, ui_prime: Array<number>): number {
		let product = 1;
	...
	update(): void {
		if (global.flags.flag_simulating && simulation_manager.solutions_ready) {
			if (this.elm.consistent()) {
				...
				this.elm.properties['V_partial1'] = global.utils.limit(this.partial_xor(0, [this.elm.properties['V_1'], this.elm.properties['V_2']],
					[this.elm.properties['V_1_prime'], this.elm.properties['V_2_prime']]), 0.0, 1.0);
				this.elm.properties['V_partial2'] = global.utils.limit(this.partial_xor(1, [this.elm.properties['V_1'], this.elm.properties['V_2']],
					[this.elm.properties['V_1_prime'], this.elm.properties['V_2_prime']]), 0.0, 1.0);
	...
	stamp(): void {
		if (this.elm.consistent()) {
			engine_functions.stamp_gate2(this.elm.n3, this.elm.properties['V_partial1'], this.elm.properties['V_partial2'], this.elm.properties['V_eq'], simulation_manager.ELEMENT_XOR_OFFSET + this.simulation_id);
		}
	}
	...
	build_element(): void {
		if (
			...
			let cache_6: number = 1.05 * this.x_space;
			let cache_7: number = 1.05 * this.y_space;
			let cache_8: number = 2.5 * this.x_space;
			let cache_9: number = 2.5 * this.y_space;
			let cache_10: number = this.x_space;
			let cache_11: number = this.y_space;
			this.xor_0.x = this.p1.x + cache_0 * global.utils.cosine(this.theta);
			this.xor_0.y = this.p1.y + cache_1 * global.utils.sine(this.theta);
			this.xor_1.x = this.xor_0.x + cache_2 * global.utils.cosine(this.theta_m90);
			this.xor_1.y = this.xor_0.y + cache_3 * global.utils.sine(this.theta_m90);
			this.xor_2.x = this.xor_1.x + cache_2 * global.utils.cosine(this.theta - Math.PI);
			this.xor_2.y = this.xor_1.y + cache_3 * global.utils.sine(this.theta - Math.PI);
			this.xor_9.x = this.xor_0.x + cache_4 * global.utils.cosine(this.theta_m90) + cache_2 * global.utils.cosine(this.theta - Math.PI);
			this.xor_9.y = this.xor_0.y + cache_5 * global.utils.sine(this.theta_m90) + cache_3 * global.utils.sine(this.theta - Math.PI);
			this.xor_7.x = this.xor_0.x + cache_6 * global.utils.cosine(this.theta_m90);
			this.xor_7.y = this.xor_0.y + cache_7 * global.utils.sine(this.theta_m90);
			this.xor_3.x = this.p1.x + cache_8 * global.utils.cosine(this.theta);
			this.xor_3.y = this.p1.y + cache_9 * global.utils.sine(this.theta);
			this.xor_4.x = this.xor_3.x + cache_2 * global.utils.cosine(this.theta_m90);
			this.xor_4.y = this.xor_3.y + cache_3 * global.utils.sine(this.theta_m90);
			this.xor_5.x = this.xor_4.x + cache_2 * global.utils.cosine(this.theta);
			this.xor_5.y = this.xor_4.y + cache_3 * global.utils.sine(this.theta);
			this.xor_10.x = this.xor_3.x + cache_4 * global.utils.cosine(this.theta_m90) + cache_2 * global.utils.cosine(this.theta);
			this.xor_10.y = this.xor_3.y + cache_5 * global.utils.sine(this.theta_m90) + cache_3 * global.utils.sine(this.theta);
			this.xor_8.x = this.xor_3.x + cache_6 * global.utils.cosine(this.theta_m90);
			this.xor_8.y = this.xor_3.y + cache_7 * global.utils.sine(this.theta_m90);
			this.xor_6.x = this.p3.x - cache_2 * global.utils.cosine(this.theta_m90);
			this.xor_6.y = this.p3.y - cache_3 * global.utils.sine(this.theta_m90);
	...
	draw_component(canvas: GraphicsEngine): void {
		...
		if (
			...
			this.circle_buffer = [];
			this.line_buffer = [];
			this.line_buffer[this.indexer++] = Array(this.p1.x, this.p1.y, this.xor_0.x, this.xor_0.y);
			this.line_buffer[this.indexer++] = Array(this.xor_0.x, this.xor_0.y, this.xor_1.x, this.xor_1.y);
			this.line_buffer[this.indexer++] = Array(this.p2.x, this.p2.y, this.xor_3.x, this.xor_3.y);
			this.line_buffer[this.indexer++] = Array(this.xor_3.x, this.xor_3.y, this.xor_4.x, this.xor_4.y);
			this.line_buffer[this.indexer++] = Array(this.xor_6.x, this.xor_6.y, this.p3.x, this.p3.y);
