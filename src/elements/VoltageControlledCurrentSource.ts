...
class VoltageControlledCurrentSource {
	...
	private p3: PointF;
	private p4: PointF;
	private vccs_0: PointF;
	private vccs_1: PointF;
	private vccs_2: PointF;
	private vccs_3: PointF;
	private vccs_4: PointF;
	private vccs_5: PointF;
	private vccs_6: PointF;
	private vccs_7: PointF;
	private vccs_8: PointF;
	private vccs_9: PointF;
	private vccs_10: PointF;
	private vccs_11: PointF;
	private vccs_12: PointF;
	private vccs_13: PointF;
	private vccs_14: PointF;
	private vccs_15: PointF;
	private vccs_16: PointF;
	private c_x: number;
	private c_y: number;
	...
	constructor(type: number, id: number, n1: number, n2: number, n3: number, n4: number) {
		...
		this.elm = new Element4(id, type, global.utils.copy(global.PROPERTY.PROPERTY_VCCS));
	...
	build_element(): void {
		if (
			...
			this.vccs_0.x = this.p1.x + cache_14 * global.utils.cosine(this.theta_m90);
			this.vccs_0.y = this.p1.y + cache_15 * global.utils.sine(this.theta_m90);
			this.vccs_1.x = this.p2.x + cache_14 * global.utils.cosine(this.theta_m90);
			this.vccs_1.y = this.p2.y + cache_15 * global.utils.sine(this.theta_m90);
			this.vccs_2.x = this.p1.x + cache_0 * global.utils.cosine(this.theta_m90);
			this.vccs_2.y = this.p1.y + cache_1 * global.utils.sine(this.theta_m90);
			this.vccs_3.x = this.p2.x + cache_0 * global.utils.cosine(this.theta_m90);
			this.vccs_3.y = this.p2.y + cache_1 * global.utils.sine(this.theta_m90);
			this.vccs_4.x = this.vccs_2.x + cache_14 * global.utils.cosine(this.theta);
			this.vccs_4.y = this.vccs_2.y + cache_15 * global.utils.sine(this.theta);
			this.vccs_5.x = this.vccs_4.x + cache_2 * global.utils.cosine(this.theta - global.CONSTANTS.PI_DIV_4);
			this.vccs_5.y = this.vccs_4.y + cache_3 * global.utils.sine(this.theta - global.CONSTANTS.PI_DIV_4);
			this.vccs_6.x = this.vccs_4.x + cache_2 * global.utils.cosine(this.theta + global.CONSTANTS.PI_DIV_4);
			this.vccs_6.y = this.vccs_4.y + cache_3 * global.utils.sine(this.theta + global.CONSTANTS.PI_DIV_4);
			this.vccs_7.x = this.vccs_2.x + cache_0 * global.utils.cosine(this.theta);
			this.vccs_7.y = this.vccs_2.y + cache_1 * global.utils.sine(this.theta);
			this.vccs_8.x = this.vccs_7.x - cache_2 * global.utils.cosine(this.theta - global.CONSTANTS.PI_DIV_4);
			this.vccs_8.y = this.vccs_7.y - cache_3 * global.utils.sine(this.theta - global.CONSTANTS.PI_DIV_4);
			this.vccs_9.x = this.vccs_7.x - cache_2 * global.utils.cosine(this.theta + global.CONSTANTS.PI_DIV_4);
			this.vccs_9.y = this.vccs_7.y - cache_3 * global.utils.sine(this.theta + global.CONSTANTS.PI_DIV_4);
			this.vccs_10.x = this.vccs_2.x + cache_4 * global.utils.cosine(this.theta);
			this.vccs_10.y = this.vccs_2.y + cache_5 * global.utils.sine(this.theta);
			this.vccs_11.x = this.vccs_2.x + cache_6 * global.utils.cosine(this.theta);
			this.vccs_11.y = this.vccs_2.y + cache_7 * global.utils.sine(this.theta);
			this.vccs_12.x = this.vccs_2.x + cache_8 * global.utils.cosine(this.theta) + (cache_14 >> 2) * global.utils.cosine(this.theta_m90);
			this.vccs_12.y = this.vccs_2.y + cache_9 * global.utils.sine(this.theta) + (cache_15 >> 2) * global.utils.sine(this.theta_m90);
			this.vccs_13.x = this.vccs_2.x + cache_8 * global.utils.cosine(this.theta) - (cache_14 >> 2) * global.utils.cosine(this.theta_m90);
			this.vccs_13.y = this.vccs_2.y + cache_9 * global.utils.sine(this.theta) - (cache_15 >> 2) * global.utils.sine(this.theta_m90);
			this.vccs_14.x = this.vccs_2.x + cache_10 * global.utils.cosine(this.theta);
			this.vccs_14.y = this.vccs_2.y + cache_11 * global.utils.sine(this.theta);
			this.vccs_15.x = this.vccs_2.x + cache_10 * global.utils.cosine(this.theta);
			this.vccs_15.y = this.vccs_2.y + cache_11 * global.utils.sine(this.theta);
			this.vccs_16.x = this.p1.x + cache_12 * global.utils.cosine(this.theta_m90 + global.CONSTANTS.PI_DIV_4);
			this.vccs_16.y = this.p1.y + cache_13 * global.utils.sine(this.theta_m90 + global.CONSTANTS.PI_DIV_4);
		...
		if (
			...
			if (global.variables.workspace_zoom_scale > 1.085 || (!MOBILE_MODE && global.variables.workspace_zoom_scale >= 0.99)) {
				...
				if ((this.angle > 170 && this.angle < 190) || (this.angle > -10 && this.angle < 10)) {
					...
					canvas.draw_text(
						global.TEMPLATES.ELEMENT_VAL_TEMPLATE.replace('{VAL}', global.utils.exponentiate_quickly(this.elm.properties['Gain'])).replace('{UNIT}', this.elm.properties['units']),
						this.c_x,
