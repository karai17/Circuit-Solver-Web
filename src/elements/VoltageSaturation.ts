...
class VoltageSaturation {
	...
	private vsat_0: PointF;
	private vsat_1: PointF;
	private vsat_2: PointF;
	private vsat_3: PointF;
	private vsat_4: PointF;
	private vsat_5: PointF;
	private vsat_6: PointF;
	private vsat_7: PointF;
	private vsat_8: PointF;
	private vsat_9: PointF;
	private c_x: number;
	private c_y: number;
	...
	constructor(type: number, id: number, n1: number, n2: number) {
		...
		this.elm = new Element2(id, type, global.utils.copy(global.PROPERTY.PROPERTY_VSAT));
		...
		this.vsat_1 = new PointF(0, 0);
		this.vsat_2 = new PointF(0, 0);
		this.vsat_3 = new PointF(0, 0);
		this.vsat_4 = new PointF(0, 0);
		this.vsat_5 = new PointF(0, 0);
		this.vsat_6 = new PointF(0, 0);
		this.vsat_7 = new PointF(0, 0);
		this.vsat_8 = new PointF(0, 0);
		this.vsat_9 = new PointF(0, 0);
	...
	update(): void {
		if (global.flags.flag_simulating && simulation_manager.solutions_ready && simulation_manager.simulation_step !== 0) {
			if (this.elm.consistent()) {
				...
				this.elm.properties['Output Voltage'] = global.utils.limit(this.elm.properties['Input Voltage'], this.elm.properties['Low Voltage'], this.elm.properties['High Voltage']);
			}
		}
	}
	stamp(): void {
		if (this.elm.consistent()) {
			engine_functions.stamp_voltage(this.elm.n2, -1, this.elm.properties['Output Voltage'], simulation_manager.ELEMENT_VSAT_OFFSET + this.simulation_id);
		}
	}
	...
	build_element(): void {
		if (
			...
			let cache_1: number = 1.0 * this.x_space;
			let cache_2: number = 1.5 * this.y_space;
			let cache_3: number = 1.0 * this.y_space;
			let cache_4: number = 0.5 * this.x_space;
			let cache_5: number = 0.5 * this.y_space;
			let cache_6: number = 0.25 * this.x_space;
			...
			this.vsat_0.x = this.c_x - cache_8 * global.utils.cosine(this.theta) + cache_8 * global.utils.cosine(this.theta_m90);
			this.vsat_0.y = this.c_y - cache_9 * global.utils.sine(this.theta) + cache_9 * global.utils.sine(this.theta_m90);
			this.vsat_2.x = this.c_x - cache_8 * global.utils.cosine(this.theta) - cache_8 * global.utils.cosine(this.theta_m90);
			this.vsat_2.y = this.c_y - cache_9 * global.utils.sine(this.theta) - cache_9 * global.utils.sine(this.theta_m90);
			this.vsat_3.x = this.c_x + cache_8 * global.utils.cosine(this.theta) - cache_8 * global.utils.cosine(this.theta_m90);
			this.vsat_3.y = this.c_y + cache_9 * global.utils.sine(this.theta) - cache_9 * global.utils.sine(this.theta_m90);
			this.vsat_4.x = this.c_x + cache_8 * global.utils.cosine(this.theta) + cache_8 * global.utils.cosine(this.theta_m90);
			this.vsat_4.y = this.c_y + cache_9 * global.utils.sine(this.theta) + cache_9 * global.utils.sine(this.theta_m90);
			this.vsat_5.x = this.c_x + cache_8 * global.utils.cosine(this.theta);
			this.vsat_5.y = this.c_y + cache_9 * global.utils.sine(this.theta);
			...
			this.vsat_6.x = this.connect1_x + cache_4 * global.utils.cosine(this.theta + global.CONSTANTS.PI_DIV_4);
			this.vsat_6.y = this.connect1_y + cache_5 * global.utils.sine(this.theta + global.CONSTANTS.PI_DIV_4);
			this.vsat_7.x = this.connect1_x + cache_4 * global.utils.cosine(this.theta + global.CONSTANTS.PI_DIV_4) + cache_6 * global.utils.cosine(this.theta);
			this.vsat_7.y = this.connect1_y + cache_5 * global.utils.sine(this.theta + global.CONSTANTS.PI_DIV_4) + cache_7 * global.utils.sine(this.theta);
			this.vsat_8.x = this.connect2_x + cache_4 * global.utils.cosine(this.theta - global.CONSTANTS.PI_DIV_2 - global.CONSTANTS.PI_DIV_4);
			this.vsat_8.y = this.connect2_y + cache_5 * global.utils.sine(this.theta - global.CONSTANTS.PI_DIV_2 - global.CONSTANTS.PI_DIV_4);
			this.vsat_9.x = this.connect2_x + cache_4 * global.utils.cosine(this.theta - global.CONSTANTS.PI_DIV_2 - global.CONSTANTS.PI_DIV_4) + cache_6 * global.utils.cosine(this.theta - Math.PI);
			this.vsat_9.y = this.connect2_y + cache_5 * global.utils.sine(this.theta - global.CONSTANTS.PI_DIV_2 - global.CONSTANTS.PI_DIV_4) + cache_7 * global.utils.sine(this.theta - Math.PI);
	...
	draw_component(canvas: GraphicsEngine): void {
		...
		if (
			...
			this.circle_buffer = [];
			this.line_buffer = [];
			this.line_buffer[this.indexer++] = Array(this.vsat_0.x, this.vsat_0.y, this.vsat_2.x, this.vsat_2.y);
			this.line_buffer[this.indexer++] = Array(this.vsat_2.x, this.vsat_2.y, this.vsat_3.x, this.vsat_3.y);
			this.line_buffer[this.indexer++] = Array(this.vsat_3.x, this.vsat_3.y, this.vsat_4.x, this.vsat_4.y);
			this.line_buffer[this.indexer++] = Array(this.vsat_4.x, this.vsat_4.y, this.vsat_0.x, this.vsat_0.y);
			...
			this.line_buffer[this.indexer++] = Array(this.vsat_6.x, this.vsat_6.y, this.vsat_7.x, this.vsat_7.y);
			this.line_buffer[this.indexer++] = Array(this.vsat_7.x, this.vsat_7.y, this.vsat_9.x, this.vsat_9.y);
			...
			if (global.variables.workspace_zoom_scale > 1.085 || (!MOBILE_MODE && global.variables.workspace_zoom_scale >= 0.99)) {
				...
				if ((this.angle > 170 && this.angle < 190) || (this.angle > -10 && this.angle < 10)) {
					canvas.draw_text(
						global.TEMPLATES.DIVISION_TEXT_TEMPLATE.replace('{A}', global.utils.exponentiate_quickly(this.elm.properties['Low Voltage'])).replace(
							'{B}',
							global.TEMPLATES.ELEMENT_VAL_TEMPLATE.replace('{VAL}', global.utils.exponentiate_quickly(this.elm.properties['High Voltage'])).replace('{UNIT}', this.elm.properties['units'])
						),
						this.c_x,
