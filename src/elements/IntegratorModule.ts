...
class IntegratorModule {
	...
	constructor(type: number, id: number, n1: number, n2: number) {
		...
		this.elm = new Element2(id, type, global.utils.copy(global.PROPERTY.PROPERTY_INTEGRATOR));
	...
	build_element(): void {
		if (
			...
			this.integ_0.x = this.c_x - cache_4 * global.utils.cosine(this.theta) + cache_4 * global.utils.cosine(this.theta_m90);
			this.integ_0.y = this.c_y - cache_5 * global.utils.sine(this.theta) + cache_5 * global.utils.sine(this.theta_m90);
			this.integ_2.x = this.c_x - cache_4 * global.utils.cosine(this.theta) - cache_4 * global.utils.cosine(this.theta_m90);
			this.integ_2.y = this.c_y - cache_5 * global.utils.sine(this.theta) - cache_5 * global.utils.sine(this.theta_m90);
			this.integ_3.x = this.c_x + cache_4 * global.utils.cosine(this.theta) - cache_4 * global.utils.cosine(this.theta_m90);
			this.integ_3.y = this.c_y + cache_5 * global.utils.sine(this.theta) - cache_5 * global.utils.sine(this.theta_m90);
			this.integ_4.x = this.c_x + cache_4 * global.utils.cosine(this.theta) + cache_4 * global.utils.cosine(this.theta_m90);
			this.integ_4.y = this.c_y + cache_5 * global.utils.sine(this.theta) + cache_5 * global.utils.sine(this.theta_m90);
			this.integ_5.x = this.c_x + cache_4 * global.utils.cosine(this.theta);
			this.integ_5.y = this.c_y + cache_5 * global.utils.sine(this.theta);
