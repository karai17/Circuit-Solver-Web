...
class OperationalAmplifier {
	...
	constructor(type: number, id: number, n1: number, n2: number, n3: number) {
		...
		this.elm = new Element3(id, type, global.utils.copy(global.PROPERTY.PROPERTY_OPAMP));
	...
	build_element(): void {
		if (
			...
			let cache_11: number = 1.2 * this.y_space;
			let cache_12: number = 1.7 * this.x_space;
			let cache_13: number = 1.7 * this.y_space;
			let cache_14: number = this.x_space;
			let cache_15: number = this.y_space;
			this.op_0.x = this.p1.x + cache_0 * global.utils.cosine(this.theta);
			this.op_0.y = this.p1.y + cache_1 * global.utils.sine(this.theta);
			this.op_1.x = this.op_0.x + cache_2 * global.utils.cosine(this.theta_m90);
			this.op_1.y = this.op_0.y + cache_3 * global.utils.sine(this.theta_m90);
			this.op_2.x = this.op_1.x + cache_2 * global.utils.cosine(this.theta - Math.PI);
			this.op_2.y = this.op_1.y + cache_3 * global.utils.sine(this.theta - Math.PI);
			this.op_3.x = this.p1.x + cache_4 * global.utils.cosine(this.theta);
			this.op_3.y = this.p1.y + cache_5 * global.utils.sine(this.theta);
			this.op_4.x = this.op_3.x + cache_2 * global.utils.cosine(this.theta_m90);
			this.op_4.y = this.op_3.y + cache_3 * global.utils.sine(this.theta_m90);
			this.op_5.x = this.op_4.x + cache_2 * global.utils.cosine(this.theta);
			this.op_5.y = this.op_4.y + cache_3 * global.utils.sine(this.theta);
			this.op_6.x = this.p3.x - cache_2 * global.utils.cosine(this.theta_m90);
			this.op_6.y = this.p3.y - cache_3 * global.utils.sine(this.theta_m90);
			this.op_7.x = this.p1.x + cache_0 * global.utils.cosine(this.theta) + cache_14 * global.utils.cosine(this.theta_m90);
			this.op_7.y = this.p1.y + cache_1 * global.utils.sine(this.theta) + cache_15 * global.utils.sine(this.theta_m90);
			this.op_8.x = this.p1.x + cache_0 * global.utils.cosine(this.theta) + cache_6 * global.utils.cosine(this.theta_m90);
			this.op_8.y = this.p1.y + cache_1 * global.utils.sine(this.theta) + cache_7 * global.utils.sine(this.theta_m90);
			this.op_9.x = this.p1.x + cache_8 * global.utils.cosine(this.theta) + cache_9 * global.utils.cosine(this.theta_m90);
			this.op_9.y = this.p1.y + cache_10 * global.utils.sine(this.theta) + cache_11 * global.utils.sine(this.theta_m90);
			this.op_10.x = this.p1.x + cache_12 * global.utils.cosine(this.theta) + cache_9 * global.utils.cosine(this.theta_m90);
			this.op_10.y = this.p1.y + cache_13 * global.utils.sine(this.theta) + cache_11 * global.utils.sine(this.theta_m90);
			this.op_11.x = this.p1.x + cache_4 * global.utils.cosine(this.theta) + cache_14 * global.utils.cosine(this.theta_m90);
			this.op_11.y = this.p1.y + cache_5 * global.utils.sine(this.theta) + cache_15 * global.utils.sine(this.theta_m90);
			this.op_12.x = this.p1.x + cache_4 * global.utils.cosine(this.theta) + cache_6 * global.utils.cosine(this.theta_m90);
			this.op_12.y = this.p1.y + cache_5 * global.utils.sine(this.theta) + cache_7 * global.utils.sine(this.theta_m90);
	...
	draw_component(canvas: GraphicsEngine): void {
		...
		if (
			...
			this.circle_buffer = [];
			this.line_buffer = [];
			this.line_buffer[this.indexer++] = Array(this.p1.x, this.p1.y, this.op_0.x, this.op_0.y);
			this.line_buffer[this.indexer++] = Array(this.op_0.x, this.op_0.y, this.op_1.x, this.op_1.y);
			this.line_buffer[this.indexer++] = Array(this.p2.x, this.p2.y, this.op_3.x, this.op_3.y);
			this.line_buffer[this.indexer++] = Array(this.op_3.x, this.op_3.y, this.op_4.x, this.op_4.y);
			this.line_buffer[this.indexer++] = Array(this.op_2.x, this.op_2.y, this.op_5.x, this.op_5.y);
			this.line_buffer[this.indexer++] = Array(this.op_2.x, this.op_2.y, this.op_6.x, this.op_6.y);
			this.line_buffer[this.indexer++] = Array(this.op_5.x, this.op_5.y, this.op_6.x, this.op_6.y);
			this.line_buffer[this.indexer++] = Array(this.op_6.x, this.op_6.y, this.p3.x, this.p3.y);
			this.line_buffer[this.indexer++] = Array(this.op_7.x, this.op_7.y, this.op_8.x, this.op_8.y);
			this.line_buffer[this.indexer++] = Array(this.op_9.x, this.op_9.y, this.op_10.x, this.op_10.y);
			this.line_buffer[this.indexer++] = Array(this.op_11.x, this.op_11.y, this.op_12.x, this.op_12.y);
