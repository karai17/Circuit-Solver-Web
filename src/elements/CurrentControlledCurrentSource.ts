...
class CurrentControlledCurrentSource {
	...
	private p3: PointF;
	private p4: PointF;
	private cccs_0: PointF;
	private cccs_1: PointF;
	private cccs_2: PointF;
	private cccs_3: PointF;
	private cccs_4: PointF;
	private cccs_5: PointF;
	private cccs_6: PointF;
	private cccs_7: PointF;
	private cccs_8: PointF;
	private cccs_9: PointF;
	private cccs_10: PointF;
	private cccs_11: PointF;
	private cccs_12: PointF;
	private cccs_13: PointF;
	private cccs_14: PointF;
	private cccs_15: PointF;
	private cccs_16: PointF;
	private c_x: number;
	private c_y: number;
	...
	constructor(type: number, id: number, n1: number, n2: number, n3: number, n4: number) {
		...
		this.elm = new Element4(id, type, global.utils.copy(global.PROPERTY.PROPERTY_CCCS));
	...
	build_element(): void {
		if (
			...
			this.cccs_0.x = this.p1.x + cache_14 * global.utils.cosine(this.theta_m90);
			this.cccs_0.y = this.p1.y + cache_15 * global.utils.sine(this.theta_m90);
			this.cccs_1.x = this.p2.x + cache_14 * global.utils.cosine(this.theta_m90);
			this.cccs_1.y = this.p2.y + cache_15 * global.utils.sine(this.theta_m90);
			this.cccs_2.x = this.p1.x + cache_0 * global.utils.cosine(this.theta_m90);
			this.cccs_2.y = this.p1.y + cache_1 * global.utils.sine(this.theta_m90);
			this.cccs_3.x = this.p2.x + cache_0 * global.utils.cosine(this.theta_m90);
			this.cccs_3.y = this.p2.y + cache_1 * global.utils.sine(this.theta_m90);
			this.cccs_4.x = this.cccs_2.x + cache_14 * global.utils.cosine(this.theta);
			this.cccs_4.y = this.cccs_2.y + cache_15 * global.utils.sine(this.theta);
			this.cccs_5.x = this.cccs_4.x + cache_2 * global.utils.cosine(this.theta - global.CONSTANTS.PI_DIV_4);
			this.cccs_5.y = this.cccs_4.y + cache_3 * global.utils.sine(this.theta - global.CONSTANTS.PI_DIV_4);
			this.cccs_6.x = this.cccs_4.x + cache_2 * global.utils.cosine(this.theta + global.CONSTANTS.PI_DIV_4);
			this.cccs_6.y = this.cccs_4.y + cache_3 * global.utils.sine(this.theta + global.CONSTANTS.PI_DIV_4);
			this.cccs_7.x = this.cccs_2.x + cache_0 * global.utils.cosine(this.theta);
			this.cccs_7.y = this.cccs_2.y + cache_1 * global.utils.sine(this.theta);
			this.cccs_8.x = this.cccs_7.x - cache_2 * global.utils.cosine(this.theta - global.CONSTANTS.PI_DIV_4);
			this.cccs_8.y = this.cccs_7.y - cache_3 * global.utils.sine(this.theta - global.CONSTANTS.PI_DIV_4);
			this.cccs_9.x = this.cccs_7.x - cache_2 * global.utils.cosine(this.theta + global.CONSTANTS.PI_DIV_4);
			this.cccs_9.y = this.cccs_7.y - cache_3 * global.utils.sine(this.theta + global.CONSTANTS.PI_DIV_4);
			this.cccs_10.x = this.cccs_2.x + cache_4 * global.utils.cosine(this.theta);
			this.cccs_10.y = this.cccs_2.y + cache_5 * global.utils.sine(this.theta);
			this.cccs_11.x = this.cccs_2.x + cache_6 * global.utils.cosine(this.theta);
			this.cccs_11.y = this.cccs_2.y + cache_7 * global.utils.sine(this.theta);
			this.cccs_12.x = this.cccs_2.x + cache_8 * global.utils.cosine(this.theta) + (cache_14 >> 2) * global.utils.cosine(this.theta_m90);
			this.cccs_12.y = this.cccs_2.y + cache_9 * global.utils.sine(this.theta) + (cache_15 >> 2) * global.utils.sine(this.theta_m90);
			this.cccs_13.x = this.cccs_2.x + cache_8 * global.utils.cosine(this.theta) - (cache_14 >> 2) * global.utils.cosine(this.theta_m90);
			this.cccs_13.y = this.cccs_2.y + cache_9 * global.utils.sine(this.theta) - (cache_15 >> 2) * global.utils.sine(this.theta_m90);
			this.cccs_14.x = this.cccs_2.x + cache_10 * global.utils.cosine(this.theta);
			this.cccs_14.y = this.cccs_2.y + cache_11 * global.utils.sine(this.theta);
			this.cccs_15.x = this.cccs_2.x + cache_10 * global.utils.cosine(this.theta);
			this.cccs_15.y = this.cccs_2.y + cache_11 * global.utils.sine(this.theta);
			this.cccs_16.x = this.p1.x + cache_12 * global.utils.cosine(this.theta_m90 + global.CONSTANTS.PI_DIV_4);
			this.cccs_16.y = this.p1.y + cache_13 * global.utils.sine(this.theta_m90 + global.CONSTANTS.PI_DIV_4);
