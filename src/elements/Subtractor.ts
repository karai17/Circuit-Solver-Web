...
class Subtractor {
	...
	private p2: PointF;
	private p3: PointF;
	private subtractor_0: PointF;
	private subtractor_1: PointF;
	private subtractor_2: PointF;
	private subtractor_3: PointF;
	private subtractor_4: PointF;
	private subtractor_5: PointF;
	private subtractor_6: PointF;
	...
	constructor(type: number, id: number, n1: number, n2: number, n3: number) {
		...
		this.elm = new Element3(id, type, global.utils.copy(global.PROPERTY.PROPERTY_SUB));
	...
	stamp(): void {
		if (this.elm.consistent()) {
			engine_functions.stamp_voltage(this.elm.n3, -1, this.elm.properties['Output Voltage'], simulation_manager.ELEMENT_SUB_OFFSET + this.simulation_id);
		}
	}
	...
	build_element(): void {
		if (
			...
			this.subtractor_0.x = this.p1.x + cache_4 * global.utils.cosine(this.theta_m90);
			this.subtractor_0.y = this.p1.y + cache_5 * global.utils.sine(this.theta_m90);
			this.subtractor_1.x = this.subtractor_0.x + cache_8 * global.utils.cosine(this.theta);
			this.subtractor_1.y = this.subtractor_0.y + cache_9 * global.utils.sine(this.theta);
			this.subtractor_2.x = this.subtractor_1.x + cache_6 * global.utils.cosine(this.theta - Math.PI);
			this.subtractor_2.y = this.subtractor_1.y + cache_7 * global.utils.sine(this.theta - Math.PI);
			this.subtractor_3.x = this.p2.x + cache_4 * global.utils.cosine(this.theta_m90);
			this.subtractor_3.y = this.p2.y + cache_5 * global.utils.sine(this.theta_m90);
			this.subtractor_4.x = this.subtractor_3.x - cache_8 * global.utils.cosine(this.theta);
			this.subtractor_4.y = this.subtractor_3.y - cache_9 * global.utils.sine(this.theta);
			this.subtractor_5.x = this.subtractor_4.x + cache_6 * global.utils.cosine(this.theta);
			this.subtractor_5.y = this.subtractor_4.y + cache_7 * global.utils.sine(this.theta);
			this.subtractor_6.x = this.p3.x - cache_8 * global.utils.cosine(this.theta_m90);
			this.subtractor_6.y = this.p3.y - cache_9 * global.utils.sine(this.theta_m90);
