...
class SampleAndHold {
	...
	private p2: PointF;
	private p3: PointF;
	private sah_0: PointF;
	private sah_1: PointF;
	private sah_2: PointF;
	private sah_3: PointF;
	private sah_4: PointF;
	private sah_5: PointF;
	private sah_6: PointF;
	private sah_7: PointF;
	private sah_8: PointF;
	...
	constructor(type: number, id: number, n1: number, n2: number, n3: number) {
		...
		this.elm = new Element3(id, type, global.utils.copy(global.PROPERTY.PROPERTY_SAH));
	...
	build_element(): void {
		if (
			...
			this.sah_0.x = this.p1.x + cache_0 * global.utils.cosine(this.theta_m90);
			this.sah_0.y = this.p1.y + cache_1 * global.utils.sine(this.theta_m90);
			this.sah_1.x = this.sah_0.x + cache_6 * global.utils.cosine(this.theta);
			this.sah_1.y = this.sah_0.y + cache_7 * global.utils.sine(this.theta);
			this.sah_2.x = this.sah_1.x + cache_2 * global.utils.cosine(this.theta - Math.PI);
			this.sah_2.y = this.sah_1.y + cache_3 * global.utils.sine(this.theta - Math.PI);
			this.sah_3.x = this.p2.x + cache_0 * global.utils.cosine(this.theta_m90);
			this.sah_3.y = this.p2.y + cache_1 * global.utils.sine(this.theta_m90);
			this.sah_4.x = this.sah_3.x - cache_6 * global.utils.cosine(this.theta);
			this.sah_4.y = this.sah_3.y - cache_7 * global.utils.sine(this.theta);
			this.sah_5.x = this.sah_4.x + cache_2 * global.utils.cosine(this.theta);
			this.sah_5.y = this.sah_4.y + cache_3 * global.utils.sine(this.theta);
			this.sah_6.x = this.p3.x - cache_6 * global.utils.cosine(this.theta_m90);
			this.sah_6.y = this.p3.y - cache_7 * global.utils.sine(this.theta_m90);
			if (this.elm.flip === global.CONSTANTS.FLIP_0) {
				this.sah_7.x = this.p1.x + cache_4 * global.utils.cosine(this.theta_m90 + global.CONSTANTS.PI_DIV_4);
				this.sah_7.y = this.p1.y + cache_5 * global.utils.sine(this.theta_m90 + global.CONSTANTS.PI_DIV_4);
				this.sah_8.x = this.p2.x + cache_4 * global.utils.cosine(this.theta_m90 - global.CONSTANTS.PI_DIV_4);
				this.sah_8.y = this.p2.y + cache_5 * global.utils.sine(this.theta_m90 - global.CONSTANTS.PI_DIV_4);
			} else if (this.elm.flip === global.CONSTANTS.FLIP_180) {
				this.sah_7.x = this.p1.x + cache_4 * global.utils.cosine(this.theta_m90 - global.CONSTANTS.PI_DIV_4);
				this.sah_7.y = this.p1.y + cache_5 * global.utils.sine(this.theta_m90 - global.CONSTANTS.PI_DIV_4);
				this.sah_8.x = this.p2.x + cache_4 * global.utils.cosine(this.theta_m90 + global.CONSTANTS.PI_DIV_4);
