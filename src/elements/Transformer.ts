...
class Transformer {
	...
	private p3: PointF;
	private p4: PointF;
	private trans_0: PointF;
	private trans_1: PointF;
	private trans_2: PointF;
	private trans_3: PointF;
	private trans_4: PointF;
	private trans_5: PointF;
	private trans_6: PointF;
	private trans_7: PointF;
	private trans_8: PointF;
	private trans_9: PointF;
	private trans_10: PointF;
	private trans_11: PointF;
	private c_x: number;
	private c_y: number;
	...
	constructor(type: number, id: number, n1: number, n2: number, n3: number, n4: number) {
		...
		this.elm = new Element4(id, type, global.utils.copy(global.PROPERTY.PROPERTY_TRAN));
	...
	build_element(): void {
		if (
			...
			this.trans_0.x = this.p1.x + cache_7 * global.utils.cosine(this.theta_m90);
			this.trans_0.y = this.p1.y + cache_8 * global.utils.sine(this.theta_m90);
			this.trans_1.x = this.p2.x + cache_7 * global.utils.cosine(this.theta_m90);
			this.trans_1.y = this.p2.y + cache_8 * global.utils.sine(this.theta_m90);
			this.trans_2.x = this.p1.x + cache_0 * global.utils.cosine(this.theta_m90);
			this.trans_2.y = this.p1.y + cache_1 * global.utils.sine(this.theta_m90);
			this.trans_3.x = this.p2.x + cache_0 * global.utils.cosine(this.theta_m90);
			this.trans_3.y = this.p2.y + cache_1 * global.utils.sine(this.theta_m90);
			this.trans_4.x = this.trans_0.x + cache_7 * global.utils.cosine(this.theta);
			this.trans_4.y = this.trans_0.y + cache_8 * global.utils.sine(this.theta);
			this.trans_5.x = this.trans_0.x + cache_2 * global.utils.cosine(this.theta);
			this.trans_5.y = this.trans_0.y + cache_3 * global.utils.sine(this.theta);
			this.trans_6.x = this.trans_0.x + cache_0 * global.utils.cosine(this.theta);
			this.trans_6.y = this.trans_0.y + cache_1 * global.utils.sine(this.theta);
			this.trans_7.x = this.trans_2.x + cache_7 * global.utils.cosine(this.theta);
			this.trans_7.y = this.trans_2.y + cache_8 * global.utils.sine(this.theta);
			this.trans_8.x = this.trans_2.x + cache_2 * global.utils.cosine(this.theta);
			this.trans_8.y = this.trans_2.y + cache_3 * global.utils.sine(this.theta);
			this.trans_9.x = this.trans_2.x + cache_0 * global.utils.cosine(this.theta);
			this.trans_9.y = this.trans_2.y + cache_1 * global.utils.sine(this.theta);
			this.trans_10.x = this.trans_4.x - cache_4 * global.utils.cosine(this.theta_m90);
			this.trans_10.y = this.trans_4.y - cache_5 * global.utils.sine(this.theta_m90);
			this.trans_11.y = this.trans_7.y + cache_6 * global.utils.sine(this.theta_m90);
			this.trans_11.x = this.trans_7.x + cache_4 * global.utils.cosine(this.theta_m90);
	...
	draw_component(canvas: GraphicsEngine): void {
		...
		if (
			...
			this.circle_buffer = [];
			this.line_buffer = [];
			this.line_buffer[this.indexer++] = Array(this.p1.x, this.p1.y, this.trans_0.x, this.trans_0.y);
			this.line_buffer[this.indexer++] = Array(this.p2.x, this.p2.y, this.trans_1.x, this.trans_1.y);
			this.line_buffer[this.indexer++] = Array(this.p3.x, this.p3.y, this.trans_2.x, this.trans_2.y);
			...
			this.circle_buffer[this.indexer++] = Array(this.trans_10.x, this.trans_10.y, global.variables.canvas_stroke_width_2_zoom);
			this.circle_buffer[this.indexer++] = Array(this.trans_11.x, this.trans_11.y, global.variables.canvas_stroke_width_2_zoom);
			...
			if (global.variables.workspace_zoom_scale > 1.085 || (!MOBILE_MODE && global.variables.workspace_zoom_scale >= 0.99)) {
				...
				if ((this.angle > 170 && this.angle < 190) || (this.angle > -10 && this.angle < 10)) {
					...
					canvas.draw_text(
						global.TEMPLATES.ELEMENT_VAL_TEMPLATE.replace('{VAL}', global.utils.exponentiate_quickly(this.elm.properties['Turns Ratio'])).replace('{UNIT}', this.elm.properties['units']),
						this.c_x,
