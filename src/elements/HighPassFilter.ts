...
class HighPassFilter {
	...
	constructor(type: number, id: number, n1: number, n2: number) {
		...
		this.elm = new Element2(id, type, global.utils.copy(global.PROPERTY.PROPERTY_HPF));
	...
	build_element(): void {
		if (
			...
			this.hpf_0.x = this.c_x - cache_8 * global.utils.cosine(this.theta) + cache_8 * global.utils.cosine(this.theta_m90);
			this.hpf_0.y = this.c_y - cache_9 * global.utils.sine(this.theta) + cache_9 * global.utils.sine(this.theta_m90);
			this.hpf_2.x = this.c_x - cache_8 * global.utils.cosine(this.theta) - cache_8 * global.utils.cosine(this.theta_m90);
			this.hpf_2.y = this.c_y - cache_9 * global.utils.sine(this.theta) - cache_9 * global.utils.sine(this.theta_m90);
			this.hpf_3.x = this.c_x + cache_8 * global.utils.cosine(this.theta) - cache_8 * global.utils.cosine(this.theta_m90);
			this.hpf_3.y = this.c_y + cache_9 * global.utils.sine(this.theta) - cache_9 * global.utils.sine(this.theta_m90);
			this.hpf_4.x = this.c_x + cache_8 * global.utils.cosine(this.theta) + cache_8 * global.utils.cosine(this.theta_m90);
			this.hpf_4.y = this.c_y + cache_9 * global.utils.sine(this.theta) + cache_9 * global.utils.sine(this.theta_m90);
			this.hpf_5.x = this.c_x + cache_8 * global.utils.cosine(this.theta);
			this.hpf_5.y = this.c_y + cache_9 * global.utils.sine(this.theta);
			this.hpf_6.x = this.c_x - cache_4 * global.utils.cosine(this.theta) - cache_5 * global.utils.cosine(this.theta_m90);
			this.hpf_6.y = this.c_y - cache_6 * global.utils.sine(this.theta) - cache_7 * global.utils.sine(this.theta_m90);
			this.hpf_7.x = this.c_x + cache_5 * global.utils.cosine(this.theta) - cache_5 * global.utils.cosine(this.theta_m90);
			this.hpf_7.y = this.c_y + cache_7 * global.utils.sine(this.theta) - cache_7 * global.utils.sine(this.theta_m90);
			this.hpf_8.x = this.c_x + cache_4 * global.utils.cosine(this.theta) + cache_5 * global.utils.cosine(this.theta_m90);
			this.hpf_8.y = this.c_y + cache_6 * global.utils.sine(this.theta) + cache_7 * global.utils.sine(this.theta_m90);
